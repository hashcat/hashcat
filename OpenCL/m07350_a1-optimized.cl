...
KERNEL_FQ void HC_ATTR_SEQ m07350_m04 (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  salt_buf5[0] = salt_bufs[SALT_POS_HOST].salt_buf[20];
  salt_buf5[1] = salt_bufs[SALT_POS_HOST].salt_buf[21];
  salt_buf5[2] = salt_bufs[SALT_POS_HOST].salt_buf[22];
  salt_buf5[3] = salt_bufs[SALT_POS_HOST].salt_buf[23];
  salt_buf6[0] = salt_bufs[SALT_POS_HOST].salt_buf[24];
  salt_buf6[1] = salt_bufs[SALT_POS_HOST].salt_buf[25];
  salt_buf6[2] = salt_bufs[SALT_POS_HOST].salt_buf[26];
  salt_buf6[3] = salt_bufs[SALT_POS_HOST].salt_buf[27];
  salt_buf7[0] = salt_bufs[SALT_POS_HOST].salt_buf[28];
  salt_buf7[1] = salt_bufs[SALT_POS_HOST].salt_buf[29];
  salt_buf7[2] = salt_bufs[SALT_POS_HOST].salt_buf[30];
  salt_buf7[3] = salt_bufs[SALT_POS_HOST].salt_buf[31];
...
KERNEL_FQ void HC_ATTR_SEQ m07350_m08 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ void HC_ATTR_SEQ m07350_m16 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ void HC_ATTR_SEQ m07350_s04 (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m07350_s08 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ void HC_ATTR_SEQ m07350_s16 (KERN_ATTR_BASIC ())
{
}
