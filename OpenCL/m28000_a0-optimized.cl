...
KERNEL_FQ void HC_ATTR_SEQ m28000_m04 (KERN_ATTR_RULES_ESALT (crc64_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m28000_m08 (KERN_ATTR_RULES_ESALT (crc64_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m28000_m16 (KERN_ATTR_RULES_ESALT (crc64_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m28000_s04 (KERN_ATTR_RULES_ESALT (crc64_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m28000_s08 (KERN_ATTR_RULES_ESALT (crc64_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m28000_s16 (KERN_ATTR_RULES_ESALT (crc64_t))
{
}
