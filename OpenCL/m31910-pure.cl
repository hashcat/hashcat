...
KERNEL_FQ KERNEL_FA void m31910_init (KERN_ATTR_TMPS_ESALT (pbkdf2_sha512_tmp_t, pbkdf2_sha512_aes_cbc_t))
{
  /**
   * base
   */
...
KERNEL_FQ KERNEL_FA void m31910_loop (KERN_ATTR_TMPS_ESALT (pbkdf2_sha512_tmp_t, pbkdf2_sha512_aes_cbc_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ KERNEL_FA void m31910_comp (KERN_ATTR_TMPS_ESALT (pbkdf2_sha512_tmp_t, pbkdf2_sha512_aes_cbc_t))
{
  const u64 gid = get_global_id (0);
