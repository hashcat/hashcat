...
KERNEL_FQ void HC_ATTR_SEQ m15400_m04 (KERN_ATTR_VECTOR_ESALT (chacha20_t))
{
  // fixed size 32
}

KERNEL_FQ void HC_ATTR_SEQ m15400_m08 (KERN_ATTR_VECTOR_ESALT (chacha20_t))
{
  // fixed size 32
}

KERNEL_FQ void HC_ATTR_SEQ m15400_m16 (KERN_ATTR_VECTOR_ESALT (chacha20_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m15400_s04 (KERN_ATTR_VECTOR_ESALT (chacha20_t))
{
  // fixed size 32
}

KERNEL_FQ void HC_ATTR_SEQ m15400_s08 (KERN_ATTR_VECTOR_ESALT (chacha20_t))
{
  // fixed size 32
}

KERNEL_FQ void HC_ATTR_SEQ m15400_s16 (KERN_ATTR_VECTOR_ESALT (chacha20_t))
{
  /**
   * modifier
   */
