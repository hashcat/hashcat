...
KERNEL_FQ void m20700_m04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < il_cnt; il_pos += VECT_SIZE)
  {
    ...
    append_0x80_4x4 (s0, s1, s2, s3, 16 ^ 3);
...
KERNEL_FQ void m20700_m08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m20700_m16 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m20700_s04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m20700_s08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m20700_s16 (KERN_ATTR_RULES ())
{
}
