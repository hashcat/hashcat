...
DECLSPEC bool pcfg_hash (PRIVATE_AS const pcfg_hash_ctx_t *hc, PRIVATE_AS u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  ...
  streebog512_hmac_init_swap (&ctx, w, len, s_sbob_sl64);

  streebog512_hmac_update (&ctx, hc->s, hc->salt_len);
...
#define PCFG_KERNEL_MXX m11850_mxx
#define PCFG_KERNEL_SXX m11850_sxx
