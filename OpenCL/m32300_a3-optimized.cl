...
KERNEL_FQ void HC_ATTR_SEQ m32300_m04 (KERN_ATTR_VECTOR_ESALT (md5_triple_salt_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32300_m08 (KERN_ATTR_VECTOR_ESALT (md5_triple_salt_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32300_m16 (KERN_ATTR_VECTOR_ESALT (md5_triple_salt_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32300_s04 (KERN_ATTR_VECTOR_ESALT (md5_triple_salt_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32300_s08 (KERN_ATTR_VECTOR_ESALT (md5_triple_salt_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32300_s16 (KERN_ATTR_VECTOR_ESALT (md5_triple_salt_t))
{
  /**
   * base
   */
