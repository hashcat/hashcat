...
KERNEL_FQ void m70000_init (KERN_ATTR_TMPS (argon2_reference_tmp_t))
{
...
KERNEL_FQ void m70000_loop (KERN_ATTR_TMPS (argon2_reference_tmp_t))
{
}

KERNEL_FQ void m70000_comp (KERN_ATTR_TMPS (argon2_reference_tmp_t))
{
  /**
   * base
   */
