...
KERNEL_FQ void HC_ATTR_SEQ m05400_m04 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m05400_m08 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m05400_m16 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m05400_s04 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m05400_s08 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m05400_s16 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
}
