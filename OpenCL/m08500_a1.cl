...
DECLSPEC void _des_crypt_encrypt (u32 iv[2], u32x data[2], u32x Kc[16], u32x Kd[16], __local u32 (*s_SPtrans)[64])
{
  u32 r = data[0];
  u32 l = data[1];
...
DECLSPEC void transform_racf_key (const u32 w0, const u32x w1, u32x key[2])
{
