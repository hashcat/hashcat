...
KERNEL_FQ void HC_ATTR_SEQ m13100_m04 (KERN_ATTR_RULES_ESALT (krb5tgs_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m13100_m08 (KERN_ATTR_RULES_ESALT (krb5tgs_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m13100_m16 (KERN_ATTR_RULES_ESALT (krb5tgs_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m13100_s04 (KERN_ATTR_RULES_ESALT (krb5tgs_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m13100_s08 (KERN_ATTR_RULES_ESALT (krb5tgs_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m13100_s16 (KERN_ATTR_RULES_ESALT (krb5tgs_t))
{
}
