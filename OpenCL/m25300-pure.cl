...
KERNEL_FQ void HC_ATTR_SEQ m25300_init (KERN_ATTR_TMPS (office2016_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m25300_loop (KERN_ATTR_TMPS (office2016_tmp_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m25300_comp (KERN_ATTR_TMPS (office2016_tmp_t))
{
  const u64 gid = get_global_id (0);
