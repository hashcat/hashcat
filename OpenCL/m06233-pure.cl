...
KERNEL_FQ void HC_ATTR_SEQ m06233_init (KERN_ATTR_TMPS_ESALT (tc_tmp_t, tc_t))
{
...
KERNEL_FQ void HC_ATTR_SEQ m06233_loop (KERN_ATTR_TMPS_ESALT (tc_tmp_t, tc_t))
{
  /**
   * Whirlpool shared
   */
...
KERNEL_FQ void HC_ATTR_SEQ m06233_comp (KERN_ATTR_TMPS_ESALT (tc_tmp_t, tc_t))
{
  const u64 gid = get_global_id (0);
  const u64 lid = get_local_id (0);
  const u64 lsz = get_local_size (0);
