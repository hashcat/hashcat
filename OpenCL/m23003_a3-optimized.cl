...
KERNEL_FQ void HC_ATTR_SEQ m23003_m04 (KERN_ATTR_VECTOR_ESALT (securezip_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23003_m08 (KERN_ATTR_VECTOR_ESALT (securezip_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23003_m16 (KERN_ATTR_VECTOR_ESALT (securezip_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23003_s04 (KERN_ATTR_VECTOR_ESALT (securezip_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23003_s08 (KERN_ATTR_VECTOR_ESALT (securezip_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23003_s16 (KERN_ATTR_VECTOR_ESALT (securezip_t))
{
  /**
   * base
   */
