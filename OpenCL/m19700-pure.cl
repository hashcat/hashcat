...
KERNEL_FQ void HC_ATTR_SEQ m19700_init (KERN_ATTR_TMPS_ESALT (krb5tgs_18_tmp_t, krb5tgs_18_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m19700_loop (KERN_ATTR_TMPS_ESALT (krb5tgs_18_tmp_t, krb5tgs_18_t))
{
   /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m19700_comp (KERN_ATTR_TMPS_ESALT (krb5tgs_18_tmp_t, krb5tgs_18_t))
{
  /**
   * base
   */
