...
KERNEL_FQ void HC_ATTR_SEQ m18200_m04 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m18200_m08 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m18200_m16 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m18200_s04 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m18200_s08 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m18200_s16 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
}
