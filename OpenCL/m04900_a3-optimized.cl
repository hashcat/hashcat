...
DECLSPEC void m04900m (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_BASIC ())
{
  /**
  ...
  salt_buf0_t[0] = salt_bufs[SALT_POS_HOST].salt_buf[ 0];
  salt_buf0_t[1] = salt_bufs[SALT_POS_HOST].salt_buf[ 1];
  salt_buf0_t[2] = salt_bufs[SALT_POS_HOST].salt_buf[ 2];
  salt_buf0_t[3] = salt_bufs[SALT_POS_HOST].salt_buf[ 3];
  salt_buf1_t[0] = salt_bufs[SALT_POS_HOST].salt_buf[ 4];
  salt_buf1_t[1] = salt_bufs[SALT_POS_HOST].salt_buf[ 5];
  salt_buf1_t[2] = salt_bufs[SALT_POS_HOST].salt_buf[ 6];
  salt_buf1_t[3] = salt_bufs[SALT_POS_HOST].salt_buf[ 7];
  salt_buf2_t[0] = salt_bufs[SALT_POS_HOST].salt_buf[ 8];
  salt_buf2_t[1] = salt_bufs[SALT_POS_HOST].salt_buf[ 9];
  salt_buf2_t[2] = salt_bufs[SALT_POS_HOST].salt_buf[10];
  salt_buf2_t[3] = salt_bufs[SALT_POS_HOST].salt_buf[11];
  salt_buf3_t[0] = salt_bufs[SALT_POS_HOST].salt_buf[12];
  salt_buf3_t[1] = salt_bufs[SALT_POS_HOST].salt_buf[13];
  salt_buf3_t[2] = salt_bufs[SALT_POS_HOST].salt_buf[14];
  salt_buf3_t[3] = salt_bufs[SALT_POS_HOST].salt_buf[15];
...
DECLSPEC void m04900s (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_BASIC ())
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void HC_ATTR_SEQ m04900_m04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m04900_m08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m04900_m16 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m04900_s04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m04900_s08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
