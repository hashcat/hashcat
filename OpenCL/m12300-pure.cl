...
KERNEL_FQ void HC_ATTR_SEQ m12300_init (KERN_ATTR_TMPS (oraclet_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m12300_loop (KERN_ATTR_TMPS (oraclet_tmp_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m12300_comp (KERN_ATTR_TMPS (oraclet_tmp_t))
{
  /**
   * base
   */
