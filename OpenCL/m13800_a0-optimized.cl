...
KERNEL_FQ void HC_ATTR_SEQ m13800_m04 (KERN_ATTR_RULES_ESALT (win8phone_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m13800_m08 (KERN_ATTR_RULES_ESALT (win8phone_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m13800_m16 (KERN_ATTR_RULES_ESALT (win8phone_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m13800_s04 (KERN_ATTR_RULES_ESALT (win8phone_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m13800_s08 (KERN_ATTR_RULES_ESALT (win8phone_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m13800_s16 (KERN_ATTR_RULES_ESALT (win8phone_t))
{
}
