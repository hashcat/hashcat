...
KERNEL_FQ void HC_ATTR_SEQ m06700_init (KERN_ATTR_TMPS (sha1aix_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m06700_loop (KERN_ATTR_TMPS (sha1aix_tmp_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m06700_comp (KERN_ATTR_TMPS (sha1aix_tmp_t))
{
  /**
   * base
   */
