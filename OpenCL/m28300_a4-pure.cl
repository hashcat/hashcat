...
#define PCFG_HASH_SHARED_BIND(hc) (hc)->s_bin2base64 = s_bin2base64;
#endif
...
{
  #ifdef REAL_SHM
  LOCAL_AS u32 *s_bin2base64 = hc->s_bin2base64;
  #else
...
#define PCFG_KERNEL_MXX m28300_mxx
#define PCFG_KERNEL_SXX m28300_sxx
