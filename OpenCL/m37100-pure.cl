...
typedef struct wpa
{
  ...
  u32  type;            // 3 = PMKID FT, 4 = EAPOL (to differentiate it from the classic WPA-PSK types (-m 22000): 1 - PMKID; 2 - EAPOL)
...
KERNEL_FQ KERNEL_FA void m37100_init (KERN_ATTR_TMPS_ESALT (wpa_pbkdf2_tmp_t, wpa_t))
{
  /**
   * base
   */
...
KERNEL_FQ KERNEL_FA void m37100_loop (KERN_ATTR_TMPS_ESALT (wpa_pbkdf2_tmp_t, wpa_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ KERNEL_FA void m37100_comp (KERN_ATTR_TMPS_ESALT (wpa_pbkdf2_tmp_t, wpa_t))
{
  // not in use here, special case...
}

KERNEL_FQ KERNEL_FA void m37100_aux1 (KERN_ATTR_TMPS_ESALT (wpa_pbkdf2_tmp_t, wpa_t))
{
  const u64 gid = get_global_id (0);
  ...
  pke[25] = wpa->pke_r0[25];
  pke[26] = wpa->pke_r0[26];
  pke[27] = wpa->pke_r0[27];
  pke[28] = wpa->pke_r0[28];
  pke[29] = wpa->pke_r0[29];
  pke[30] = wpa->pke_r0[30];
  pke[31] = wpa->pke_r0[31];
...
KERNEL_FQ KERNEL_FA void m37100_aux2 (KERN_ATTR_TMPS_ESALT (wpa_pbkdf2_tmp_t, wpa_t))
{
  /**
   * aes shared
   */
  ...
  // step 2: compute PMK-R1 = KDF-256(PMK-R1, COUNTER || "FT-R1" || R1KH-ID || MAC-CLIENT || SIZE(256))
  ...
  pke[16] = wpa->pke_r1[16];
  pke[17] = wpa->pke_r1[17];
  pke[18] = wpa->pke_r1[18];
  pke[19] = wpa->pke_r1[19];
  pke[20] = wpa->pke_r1[20];
  pke[21] = wpa->pke_r1[21];
  pke[22] = wpa->pke_r1[22];
  pke[23] = wpa->pke_r1[23];
  pke[24] = wpa->pke_r1[24];
  pke[25] = wpa->pke_r1[25];
  pke[26] = wpa->pke_r1[26];
  pke[27] = wpa->pke_r1[27];
  pke[28] = wpa->pke_r1[28];
  pke[29] = wpa->pke_r1[29];
  pke[30] = wpa->pke_r1[30];
  pke[31] = wpa->pke_r1[31];
