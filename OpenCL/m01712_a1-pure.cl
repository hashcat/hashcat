...
KERNEL_FQ void m01712_mxx (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos++)
  {
    ...
    sha512_update_global_swap (&ctx, combs_buf[il_pos].i, combs_buf[il_pos].pw_len + 1);
...
KERNEL_FQ void m01712_sxx (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
