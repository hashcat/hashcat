...
KERNEL_FQ void HC_ATTR_SEQ m16600_mxx (KERN_ATTR_VECTOR_ESALT (electrum_wallet_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m16600_sxx (KERN_ATTR_VECTOR_ESALT (electrum_wallet_t))
{
  /**
   * base
   */
