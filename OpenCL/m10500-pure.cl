...
KERNEL_FQ void HC_ATTR_SEQ m10500_init (KERN_ATTR_TMPS_ESALT (pdf14_tmp_t, pdf_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m10500_loop (KERN_ATTR_TMPS_ESALT (pdf14_tmp_t, pdf_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m10500_comp (KERN_ATTR_TMPS_ESALT (pdf14_tmp_t, pdf_t))
{
  /**
   * modifier
   */
