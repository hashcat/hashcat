...
DECLSPEC bool pcfg_oldoffice01_key (PRIVATE_AS const pcfg_hash_ctx_t *hc, PRIVATE_AS const u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  u32 t[4];
...
DECLSPEC bool pcfg_hash (PRIVATE_AS const pcfg_hash_ctx_t *hc, PRIVATE_AS u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  ...
  return pcfg_oldoffice01_key (hc, w, len, dgst);
}
...
DECLSPEC bool pcfg_hash_global (PRIVATE_AS const pcfg_hash_ctx_t *hc, GLOBAL_AS const u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  ...
  return pcfg_oldoffice01_key (hc, t, len, dgst);
}

#define PCFG_KERNEL_MXX m09720_mxx
#define PCFG_KERNEL_SXX m09720_sxx
