...
DECLSPEC void m05510m (SHM_TYPE u32 (*s_SPtrans)[64], SHM_TYPE u32 (*s_skb)[64], u32 *w, const u32 pw_len, KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
DECLSPEC void m05510s (SHM_TYPE u32 (*s_SPtrans)[64], SHM_TYPE u32 (*s_skb)[64], u32 *w, const u32 pw_len, KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05510_m04 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05510_m08 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05510_m16 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05510_s04 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05510_s08 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05510_s16 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
