...
KERNEL_FQ void HC_ATTR_SEQ m19300_mxx (KERN_ATTR_RULES_ESALT (sha1_double_salt_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m19300_sxx (KERN_ATTR_RULES_ESALT (sha1_double_salt_t))
{
  /**
   * modifier
   */
