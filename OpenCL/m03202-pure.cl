...
KERNEL_FQ void FIXED_THREAD_COUNT(FIXED_LOCAL_SIZE) m03202_init (KERN_ATTR_TMPS (bcrypt_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void FIXED_THREAD_COUNT(FIXED_LOCAL_SIZE) m03202_loop (KERN_ATTR_TMPS (bcrypt_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void FIXED_THREAD_COUNT(FIXED_LOCAL_SIZE) m03202_comp (KERN_ATTR_TMPS (bcrypt_tmp_t))
{
  /**
   * base
   */
