...
DECLSPEC void m27200m (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_BASIC ())
{
  /**
...
KERNEL_FQ void HC_ATTR_SEQ m27200_m04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m27200_m08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m27200_m16 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m27200_s04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m27200_s08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m27200_s16 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
