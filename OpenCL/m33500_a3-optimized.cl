...
KERNEL_FQ void HC_ATTR_SEQ m33500_m04 (KERN_ATTR_ESALT (rc4_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m33500_m08 (KERN_ATTR_ESALT (rc4_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m33500_m16 (KERN_ATTR_ESALT (rc4_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m33500_s04 (KERN_ATTR_ESALT (rc4_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m33500_s08 (KERN_ATTR_ESALT (rc4_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m33500_s16 (KERN_ATTR_ESALT (rc4_t))
{
  /**
   * base
   */
