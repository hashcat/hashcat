...
KERNEL_FQ void HC_ATTR_SEQ m23100_init (KERN_ATTR_TMPS_ESALT (keychain_tmp_t, keychain_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23100_loop (KERN_ATTR_TMPS_ESALT (keychain_tmp_t, keychain_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m23100_comp (KERN_ATTR_TMPS_ESALT (keychain_tmp_t, keychain_t))
{
  /**
   * base
   */
