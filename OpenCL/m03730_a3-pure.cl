...
KERNEL_FQ void HC_ATTR_SEQ m03730_mxx (KERN_ATTR_VECTOR_ESALT (md5_double_salt_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m03730_sxx (KERN_ATTR_VECTOR_ESALT (md5_double_salt_t))
{
  /**
   * modifier
   */
