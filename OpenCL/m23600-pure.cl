...
KERNEL_FQ void HC_ATTR_SEQ m23600_init (KERN_ATTR_TMPS_ESALT (axcrypt2_tmp_t, axcrypt2_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23600_loop (KERN_ATTR_TMPS_ESALT (axcrypt2_tmp_t, axcrypt2_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m23600_init2 (KERN_ATTR_TMPS_ESALT (axcrypt2_tmp_t, axcrypt2_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23600_loop2 (KERN_ATTR_TMPS_ESALT (axcrypt2_tmp_t, axcrypt2_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23600_comp (KERN_ATTR_TMPS_ESALT (axcrypt2_tmp_t, axcrypt2_t))
{
  /**
   * base
   */
