...
KERNEL_FQ void HC_ATTR_SEQ m17020_init (KERN_ATTR_TMPS_ESALT (gpg_tmp_t, gpg_t))
{
...
KERNEL_FQ void HC_ATTR_SEQ m17020_loop_prepare (KERN_ATTR_TMPS_ESALT (gpg_tmp_t, gpg_t))
{
  const u64 gid = get_global_id (0);
