...
KERNEL_FQ void HC_ATTR_SEQ m10420_m04 (KERN_ATTR_ESALT (pdf_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m10420_m08 (KERN_ATTR_ESALT (pdf_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m10420_m16 (KERN_ATTR_ESALT (pdf_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m10420_s04 (KERN_ATTR_ESALT (pdf_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m10420_s08 (KERN_ATTR_ESALT (pdf_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m10420_s16 (KERN_ATTR_ESALT (pdf_t))
{
}
