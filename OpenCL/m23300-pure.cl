...
KERNEL_FQ void HC_ATTR_SEQ m23300_init (KERN_ATTR_TMPS_ESALT (iwork_tmp_t, iwork_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m23300_loop (KERN_ATTR_TMPS_ESALT (iwork_tmp_t, iwork_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m23300_comp (KERN_ATTR_TMPS_ESALT (iwork_tmp_t, iwork_t))
{
  const u64 gid = get_global_id (0);
