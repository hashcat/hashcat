...
{
  hc->pc256[0] = salt_bufs[salt_pos].salt_buf_pc[0];
  hc->pc256[1] = salt_bufs[salt_pos].salt_buf_pc[1];
  hc->pc256[2] = salt_bufs[salt_pos].salt_buf_pc[2];
  hc->pc256[3] = salt_bufs[salt_pos].salt_buf_pc[3];
  hc->pc256[4] = salt_bufs[salt_pos].salt_buf_pc[4];
  hc->pc256[5] = salt_bufs[salt_pos].salt_buf_pc[5];
  hc->pc256[6] = salt_bufs[salt_pos].salt_buf_pc[6];
  hc->pc256[7] = salt_bufs[salt_pos].salt_buf_pc[7];
}
...
#define PCFG_KERNEL_MXX m12600_mxx
#define PCFG_KERNEL_SXX m12600_sxx
