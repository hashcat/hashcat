...
KERNEL_FQ void m03730_m04 (KERN_ATTR_RULES_ESALT (md5_double_salt_t))
{
  /**
   * modifier
   */
  ...
  const u32 pw_salt_len = 32 + salt2_len;
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    const u32x out_salt_len = salt2_len + out_len;
...
KERNEL_FQ void m03730_m08 (KERN_ATTR_RULES_ESALT (md5_double_salt_t))
{
}

KERNEL_FQ void m03730_m16 (KERN_ATTR_RULES_ESALT (md5_double_salt_t))
{
}

KERNEL_FQ void m03730_s04 (KERN_ATTR_RULES_ESALT (md5_double_salt_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m03730_s08 (KERN_ATTR_RULES_ESALT (md5_double_salt_t))
{
}

KERNEL_FQ void m03730_s16 (KERN_ATTR_RULES_ESALT (md5_double_salt_t))
{
}
