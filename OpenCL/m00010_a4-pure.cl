...
{
  hc->salt_buf = salt_bufs[salt_pos].salt_buf;
...
DECLSPEC bool pcfg_hash (PRIVATE_AS const pcfg_hash_ctx_t *hc, PRIVATE_AS u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  ...
  md5_update_global (&ctx, hc->salt_buf, hc->salt_len);
...
#define PCFG_KERNEL_MXX m00010_mxx
#define PCFG_KERNEL_SXX m00010_sxx
