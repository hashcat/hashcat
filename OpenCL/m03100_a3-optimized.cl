...
DECLSPEC void m03100m (SHM_TYPE u32 (*s_SPtrans)[64], SHM_TYPE u32 (*s_skb)[64], PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
...
DECLSPEC void m03100s (SHM_TYPE u32 (*s_SPtrans)[64], SHM_TYPE u32 (*s_skb)[64], PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void HC_ATTR_SEQ m03100_m04 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m03100_m08 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m03100_m16 (KERN_ATTR_VECTOR ())
{
}

KERNEL_FQ void HC_ATTR_SEQ m03100_s04 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m03100_s08 (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m03100_s16 (KERN_ATTR_VECTOR ())
{
}
