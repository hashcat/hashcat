...
KERNEL_FQ void HC_ATTR_SEQ m32030_init (KERN_ATTR_TMPS (netiq_sspr_sha256_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32030_loop (KERN_ATTR_TMPS (netiq_sspr_sha256_tmp_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m32030_comp (KERN_ATTR_TMPS (netiq_sspr_sha256_tmp_t))
{
  const u64 gid = get_global_id (0);
