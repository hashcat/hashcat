...
// The decrypt key schedule inverts every round key, and a second set of tables folds the two
// lookups that takes into one. The plain entry points above keep the two lookup form, because
// only a hash mode whose inner loop is the key schedule itself gains anything from the fold.

CONSTANT_VK u32a td_inv0[256] =
{
...
DECLSPEC void aes128_InvertKey_inv (PRIVATE_AS u32 *ks, SHM_TYPE const u32 *s_inv0, SHM_TYPE const u32 *s_inv1, SHM_TYPE const u32 *s_inv2, SHM_TYPE const u32 *s_inv3)
{
  u32 temp;
  ...
  ks[ 4] = s_inv0[(ks[ 4] >> 24) & 0xff] ^ s_inv1[(ks[ 4] >> 16) & 0xff] ^ s_inv2[(ks[ 4] >>  8) & 0xff] ^ s_inv3[(ks[ 4] >>  0) & 0xff];
  ks[ 5] = s_inv0[(ks[ 5] >> 24) & 0xff] ^ s_inv1[(ks[ 5] >> 16) & 0xff] ^ s_inv2[(ks[ 5] >>  8) & 0xff] ^ s_inv3[(ks[ 5] >>  0) & 0xff];
  ks[ 6] = s_inv0[(ks[ 6] >> 24) & 0xff] ^ s_inv1[(ks[ 6] >> 16) & 0xff] ^ s_inv2[(ks[ 6] >>  8) & 0xff] ^ s_inv3[(ks[ 6] >>  0) & 0xff];
  ks[ 7] = s_inv0[(ks[ 7] >> 24) & 0xff] ^ s_inv1[(ks[ 7] >> 16) & 0xff] ^ s_inv2[(ks[ 7] >>  8) & 0xff] ^ s_inv3[(ks[ 7] >>  0) & 0xff];
  ks[ 8] = s_inv0[(ks[ 8] >> 24) & 0xff] ^ s_inv1[(ks[ 8] >> 16) & 0xff] ^ s_inv2[(ks[ 8] >>  8) & 0xff] ^ s_inv3[(ks[ 8] >>  0) & 0xff];
  ks[ 9] = s_inv0[(ks[ 9] >> 24) & 0xff] ^ s_inv1[(ks[ 9] >> 16) & 0xff] ^ s_inv2[(ks[ 9] >>  8) & 0xff] ^ s_inv3[(ks[ 9] >>  0) & 0xff];
  ks[10] = s_inv0[(ks[10] >> 24) & 0xff] ^ s_inv1[(ks[10] >> 16) & 0xff] ^ s_inv2[(ks[10] >>  8) & 0xff] ^ s_inv3[(ks[10] >>  0) & 0xff];
  ks[11] = s_inv0[(ks[11] >> 24) & 0xff] ^ s_inv1[(ks[11] >> 16) & 0xff] ^ s_inv2[(ks[11] >>  8) & 0xff] ^ s_inv3[(ks[11] >>  0) & 0xff];
  ks[12] = s_inv0[(ks[12] >> 24) & 0xff] ^ s_inv1[(ks[12] >> 16) & 0xff] ^ s_inv2[(ks[12] >>  8) & 0xff] ^ s_inv3[(ks[12] >>  0) & 0xff];
  ks[13] = s_inv0[(ks[13] >> 24) & 0xff] ^ s_inv1[(ks[13] >> 16) & 0xff] ^ s_inv2[(ks[13] >>  8) & 0xff] ^ s_inv3[(ks[13] >>  0) & 0xff];
  ks[14] = s_inv0[(ks[14] >> 24) & 0xff] ^ s_inv1[(ks[14] >> 16) & 0xff] ^ s_inv2[(ks[14] >>  8) & 0xff] ^ s_inv3[(ks[14] >>  0) & 0xff];
  ks[15] = s_inv0[(ks[15] >> 24) & 0xff] ^ s_inv1[(ks[15] >> 16) & 0xff] ^ s_inv2[(ks[15] >>  8) & 0xff] ^ s_inv3[(ks[15] >>  0) & 0xff];
  ks[16] = s_inv0[(ks[16] >> 24) & 0xff] ^ s_inv1[(ks[16] >> 16) & 0xff] ^ s_inv2[(ks[16] >>  8) & 0xff] ^ s_inv3[(ks[16] >>  0) & 0xff];
  ks[17] = s_inv0[(ks[17] >> 24) & 0xff] ^ s_inv1[(ks[17] >> 16) & 0xff] ^ s_inv2[(ks[17] >>  8) & 0xff] ^ s_inv3[(ks[17] >>  0) & 0xff];
  ks[18] = s_inv0[(ks[18] >> 24) & 0xff] ^ s_inv1[(ks[18] >> 16) & 0xff] ^ s_inv2[(ks[18] >>  8) & 0xff] ^ s_inv3[(ks[18] >>  0) & 0xff];
  ks[19] = s_inv0[(ks[19] >> 24) & 0xff] ^ s_inv1[(ks[19] >> 16) & 0xff] ^ s_inv2[(ks[19] >>  8) & 0xff] ^ s_inv3[(ks[19] >>  0) & 0xff];
  ks[20] = s_inv0[(ks[20] >> 24) & 0xff] ^ s_inv1[(ks[20] >> 16) & 0xff] ^ s_inv2[(ks[20] >>  8) & 0xff] ^ s_inv3[(ks[20] >>  0) & 0xff];
  ks[21] = s_inv0[(ks[21] >> 24) & 0xff] ^ s_inv1[(ks[21] >> 16) & 0xff] ^ s_inv2[(ks[21] >>  8) & 0xff] ^ s_inv3[(ks[21] >>  0) & 0xff];
  ks[22] = s_inv0[(ks[22] >> 24) & 0xff] ^ s_inv1[(ks[22] >> 16) & 0xff] ^ s_inv2[(ks[22] >>  8) & 0xff] ^ s_inv3[(ks[22] >>  0) & 0xff];
  ks[23] = s_inv0[(ks[23] >> 24) & 0xff] ^ s_inv1[(ks[23] >> 16) & 0xff] ^ s_inv2[(ks[23] >>  8) & 0xff] ^ s_inv3[(ks[23] >>  0) & 0xff];
  ks[24] = s_inv0[(ks[24] >> 24) & 0xff] ^ s_inv1[(ks[24] >> 16) & 0xff] ^ s_inv2[(ks[24] >>  8) & 0xff] ^ s_inv3[(ks[24] >>  0) & 0xff];
  ks[25] = s_inv0[(ks[25] >> 24) & 0xff] ^ s_inv1[(ks[25] >> 16) & 0xff] ^ s_inv2[(ks[25] >>  8) & 0xff] ^ s_inv3[(ks[25] >>  0) & 0xff];
  ks[26] = s_inv0[(ks[26] >> 24) & 0xff] ^ s_inv1[(ks[26] >> 16) & 0xff] ^ s_inv2[(ks[26] >>  8) & 0xff] ^ s_inv3[(ks[26] >>  0) & 0xff];
  ks[27] = s_inv0[(ks[27] >> 24) & 0xff] ^ s_inv1[(ks[27] >> 16) & 0xff] ^ s_inv2[(ks[27] >>  8) & 0xff] ^ s_inv3[(ks[27] >>  0) & 0xff];
  ks[28] = s_inv0[(ks[28] >> 24) & 0xff] ^ s_inv1[(ks[28] >> 16) & 0xff] ^ s_inv2[(ks[28] >>  8) & 0xff] ^ s_inv3[(ks[28] >>  0) & 0xff];
  ks[29] = s_inv0[(ks[29] >> 24) & 0xff] ^ s_inv1[(ks[29] >> 16) & 0xff] ^ s_inv2[(ks[29] >>  8) & 0xff] ^ s_inv3[(ks[29] >>  0) & 0xff];
  ks[30] = s_inv0[(ks[30] >> 24) & 0xff] ^ s_inv1[(ks[30] >> 16) & 0xff] ^ s_inv2[(ks[30] >>  8) & 0xff] ^ s_inv3[(ks[30] >>  0) & 0xff];
  ks[31] = s_inv0[(ks[31] >> 24) & 0xff] ^ s_inv1[(ks[31] >> 16) & 0xff] ^ s_inv2[(ks[31] >>  8) & 0xff] ^ s_inv3[(ks[31] >>  0) & 0xff];
  ks[32] = s_inv0[(ks[32] >> 24) & 0xff] ^ s_inv1[(ks[32] >> 16) & 0xff] ^ s_inv2[(ks[32] >>  8) & 0xff] ^ s_inv3[(ks[32] >>  0) & 0xff];
  ks[33] = s_inv0[(ks[33] >> 24) & 0xff] ^ s_inv1[(ks[33] >> 16) & 0xff] ^ s_inv2[(ks[33] >>  8) & 0xff] ^ s_inv3[(ks[33] >>  0) & 0xff];
  ks[34] = s_inv0[(ks[34] >> 24) & 0xff] ^ s_inv1[(ks[34] >> 16) & 0xff] ^ s_inv2[(ks[34] >>  8) & 0xff] ^ s_inv3[(ks[34] >>  0) & 0xff];
  ks[35] = s_inv0[(ks[35] >> 24) & 0xff] ^ s_inv1[(ks[35] >> 16) & 0xff] ^ s_inv2[(ks[35] >>  8) & 0xff] ^ s_inv3[(ks[35] >>  0) & 0xff];
  ks[36] = s_inv0[(ks[36] >> 24) & 0xff] ^ s_inv1[(ks[36] >> 16) & 0xff] ^ s_inv2[(ks[36] >>  8) & 0xff] ^ s_inv3[(ks[36] >>  0) & 0xff];
  ks[37] = s_inv0[(ks[37] >> 24) & 0xff] ^ s_inv1[(ks[37] >> 16) & 0xff] ^ s_inv2[(ks[37] >>  8) & 0xff] ^ s_inv3[(ks[37] >>  0) & 0xff];
  ks[38] = s_inv0[(ks[38] >> 24) & 0xff] ^ s_inv1[(ks[38] >> 16) & 0xff] ^ s_inv2[(ks[38] >>  8) & 0xff] ^ s_inv3[(ks[38] >>  0) & 0xff];
  ks[39] = s_inv0[(ks[39] >> 24) & 0xff] ^ s_inv1[(ks[39] >> 16) & 0xff] ^ s_inv2[(ks[39] >>  8) & 0xff] ^ s_inv3[(ks[39] >>  0) & 0xff];
}
...
DECLSPEC void aes192_InvertKey_inv (PRIVATE_AS u32 *ks, SHM_TYPE const u32 *s_inv0, SHM_TYPE const u32 *s_inv1, SHM_TYPE const u32 *s_inv2, SHM_TYPE const u32 *s_inv3)
{
  u32 temp;
  ...
  ks[38] = s_inv0[(ks[38] >> 24) & 0xff] ^ s_inv1[(ks[38] >> 16) & 0xff] ^ s_inv2[(ks[38] >>  8) & 0xff] ^ s_inv3[(ks[38] >>  0) & 0xff];
  ks[39] = s_inv0[(ks[39] >> 24) & 0xff] ^ s_inv1[(ks[39] >> 16) & 0xff] ^ s_inv2[(ks[39] >>  8) & 0xff] ^ s_inv3[(ks[39] >>  0) & 0xff];
  ks[40] = s_inv0[(ks[40] >> 24) & 0xff] ^ s_inv1[(ks[40] >> 16) & 0xff] ^ s_inv2[(ks[40] >>  8) & 0xff] ^ s_inv3[(ks[40] >>  0) & 0xff];
  ks[41] = s_inv0[(ks[41] >> 24) & 0xff] ^ s_inv1[(ks[41] >> 16) & 0xff] ^ s_inv2[(ks[41] >>  8) & 0xff] ^ s_inv3[(ks[41] >>  0) & 0xff];
  ks[42] = s_inv0[(ks[42] >> 24) & 0xff] ^ s_inv1[(ks[42] >> 16) & 0xff] ^ s_inv2[(ks[42] >>  8) & 0xff] ^ s_inv3[(ks[42] >>  0) & 0xff];
  ks[43] = s_inv0[(ks[43] >> 24) & 0xff] ^ s_inv1[(ks[43] >> 16) & 0xff] ^ s_inv2[(ks[43] >>  8) & 0xff] ^ s_inv3[(ks[43] >>  0) & 0xff];
  ks[44] = s_inv0[(ks[44] >> 24) & 0xff] ^ s_inv1[(ks[44] >> 16) & 0xff] ^ s_inv2[(ks[44] >>  8) & 0xff] ^ s_inv3[(ks[44] >>  0) & 0xff];
  ks[45] = s_inv0[(ks[45] >> 24) & 0xff] ^ s_inv1[(ks[45] >> 16) & 0xff] ^ s_inv2[(ks[45] >>  8) & 0xff] ^ s_inv3[(ks[45] >>  0) & 0xff];
  ks[46] = s_inv0[(ks[46] >> 24) & 0xff] ^ s_inv1[(ks[46] >> 16) & 0xff] ^ s_inv2[(ks[46] >>  8) & 0xff] ^ s_inv3[(ks[46] >>  0) & 0xff];
  ks[47] = s_inv0[(ks[47] >> 24) & 0xff] ^ s_inv1[(ks[47] >> 16) & 0xff] ^ s_inv2[(ks[47] >>  8) & 0xff] ^ s_inv3[(ks[47] >>  0) & 0xff];
}
...
DECLSPEC void aes256_InvertKey_inv (PRIVATE_AS u32 *ks, SHM_TYPE const u32 *s_inv0, SHM_TYPE const u32 *s_inv1, SHM_TYPE const u32 *s_inv2, SHM_TYPE const u32 *s_inv3)
{
  u32 temp;
  ...
  ks[46] = s_inv0[(ks[46] >> 24) & 0xff] ^ s_inv1[(ks[46] >> 16) & 0xff] ^ s_inv2[(ks[46] >>  8) & 0xff] ^ s_inv3[(ks[46] >>  0) & 0xff];
  ks[47] = s_inv0[(ks[47] >> 24) & 0xff] ^ s_inv1[(ks[47] >> 16) & 0xff] ^ s_inv2[(ks[47] >>  8) & 0xff] ^ s_inv3[(ks[47] >>  0) & 0xff];
  ks[48] = s_inv0[(ks[48] >> 24) & 0xff] ^ s_inv1[(ks[48] >> 16) & 0xff] ^ s_inv2[(ks[48] >>  8) & 0xff] ^ s_inv3[(ks[48] >>  0) & 0xff];
  ks[49] = s_inv0[(ks[49] >> 24) & 0xff] ^ s_inv1[(ks[49] >> 16) & 0xff] ^ s_inv2[(ks[49] >>  8) & 0xff] ^ s_inv3[(ks[49] >>  0) & 0xff];
  ks[50] = s_inv0[(ks[50] >> 24) & 0xff] ^ s_inv1[(ks[50] >> 16) & 0xff] ^ s_inv2[(ks[50] >>  8) & 0xff] ^ s_inv3[(ks[50] >>  0) & 0xff];
  ks[51] = s_inv0[(ks[51] >> 24) & 0xff] ^ s_inv1[(ks[51] >> 16) & 0xff] ^ s_inv2[(ks[51] >>  8) & 0xff] ^ s_inv3[(ks[51] >>  0) & 0xff];
  ks[52] = s_inv0[(ks[52] >> 24) & 0xff] ^ s_inv1[(ks[52] >> 16) & 0xff] ^ s_inv2[(ks[52] >>  8) & 0xff] ^ s_inv3[(ks[52] >>  0) & 0xff];
  ks[53] = s_inv0[(ks[53] >> 24) & 0xff] ^ s_inv1[(ks[53] >> 16) & 0xff] ^ s_inv2[(ks[53] >>  8) & 0xff] ^ s_inv3[(ks[53] >>  0) & 0xff];
  ks[54] = s_inv0[(ks[54] >> 24) & 0xff] ^ s_inv1[(ks[54] >> 16) & 0xff] ^ s_inv2[(ks[54] >>  8) & 0xff] ^ s_inv3[(ks[54] >>  0) & 0xff];
  ks[55] = s_inv0[(ks[55] >> 24) & 0xff] ^ s_inv1[(ks[55] >> 16) & 0xff] ^ s_inv2[(ks[55] >>  8) & 0xff] ^ s_inv3[(ks[55] >>  0) & 0xff];
}
