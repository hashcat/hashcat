...
KERNEL_FQ void HC_ATTR_SEQ m23002_m04 (KERN_ATTR_RULES_ESALT (securezip_t))
{
...
KERNEL_FQ void HC_ATTR_SEQ m23002_m08 (KERN_ATTR_RULES_ESALT (securezip_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m23002_m16 (KERN_ATTR_RULES_ESALT (securezip_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m23002_s04 (KERN_ATTR_RULES_ESALT (securezip_t))
{
  const u64 gid = get_global_id (0);
  const u64 lid = get_local_id (0);
  const u64 lsz = get_local_size (0);
...
KERNEL_FQ void HC_ATTR_SEQ m23002_s08 (KERN_ATTR_RULES_ESALT (securezip_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m23002_s16 (KERN_ATTR_RULES_ESALT (securezip_t))
{
}
