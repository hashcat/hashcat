...
DECLSPEC bool pcfg_hash (PRIVATE_AS const pcfg_hash_ctx_t *hc, PRIVATE_AS u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  ...
  aes192_decrypt (ks, hc->enc, dec, s_td0, s_td1, s_td2, s_td3, s_td4);
  ...
  aes192_decrypt (ks, hc->first_data, dec, s_td0, s_td1, s_td2, s_td3, s_td4);
...
#define PCFG_KERNEL_MXX m22941_mxx
#define PCFG_KERNEL_SXX m22941_sxx
