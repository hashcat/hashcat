...
KERNEL_FQ void m21920_mxx (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < il_cnt; il_pos++)
  {
    ...
    sha256_update_global_swap (&ctx_inner, pws[gid].i, pws[gid].pw_len);

    sha256_update_global_swap (&ctx_inner, combs_buf[il_pos].i, combs_buf[il_pos].pw_len);
...
KERNEL_FQ void m21920_sxx (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
