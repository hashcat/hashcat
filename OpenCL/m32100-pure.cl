...
KERNEL_FQ void HC_ATTR_SEQ m32100_init (KERN_ATTR_TMPS_ESALT (krb5asrep_17_tmp_t, krb5asrep_17_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32100_loop (KERN_ATTR_TMPS_ESALT (krb5asrep_17_tmp_t, krb5asrep_17_t))
{
   /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32100_comp (KERN_ATTR_TMPS_ESALT (krb5asrep_17_tmp_t, krb5asrep_17_t))
{
  /**
   * base
   */
