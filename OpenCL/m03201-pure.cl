...
KERNEL_FQ void FIXED_THREAD_COUNT(FIXED_LOCAL_SIZE) m03201_init (KERN_ATTR_TMPS (bcrypt_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void FIXED_THREAD_COUNT(FIXED_LOCAL_SIZE) m03201_loop (KERN_ATTR_TMPS (bcrypt_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void FIXED_THREAD_COUNT(FIXED_LOCAL_SIZE) m03201_comp (KERN_ATTR_TMPS (bcrypt_tmp_t))
{
  /**
   * base
   */
