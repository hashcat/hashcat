...
KERNEL_FQ void HC_ATTR_SEQ m32300_mxx (KERN_ATTR_VECTOR_ESALT (md5_triple_salt_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32300_sxx (KERN_ATTR_VECTOR_ESALT (md5_triple_salt_t))
{
  /**
   * modifier
   */
