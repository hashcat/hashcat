 ...
 * License.....: MIT
 *
 * BestCrypt v4 Volume Encryption - bridge-compatible kernel for scrypt-jane bridge
 */
...
KERNEL_FQ KERNEL_FA void m70800_init (KERN_ATTR_TMPS_ESALT (scrypt_tmp_t, bestcrypt_scrypt_t))
{
...
KERNEL_FQ KERNEL_FA void m70800_loop (KERN_ATTR_TMPS_ESALT (scrypt_tmp_t, bestcrypt_scrypt_t))
{
  // EMPTY - The scrypt-jane bridge replaces this
}

KERNEL_FQ KERNEL_FA void m70800_comp (KERN_ATTR_TMPS_ESALT (scrypt_tmp_t, bestcrypt_scrypt_t))
{
  /**
   * base
   */
