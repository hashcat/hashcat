...
KERNEL_FQ void HC_ATTR_SEQ m28800_init (KERN_ATTR_TMPS_ESALT (krb5db_17_tmp_t, krb5db_17_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m28800_loop (KERN_ATTR_TMPS_ESALT (krb5db_17_tmp_t, krb5db_17_t))
{
   /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m28800_comp (KERN_ATTR_TMPS_ESALT (krb5db_17_tmp_t, krb5db_17_t))
{
  /**
   * base
   */
