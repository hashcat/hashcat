...
KERNEL_FQ void HC_ATTR_SEQ l_markov (KERN_ATTR_L_MARKOV)
{
...
KERNEL_FQ void HC_ATTR_SEQ r_markov (KERN_ATTR_R_MARKOV)
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ C_markov (KERN_ATTR_C_MARKOV)
{
  const u64 gid = get_global_id (0);
