...
DECLSPEC void m07000m (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_BASIC ())
{
  /**
  ...
  const u32 salt_len = 12; // salt_bufs[SALT_POS_HOST].salt_len;
...
DECLSPEC void m07000s (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_BASIC ())
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void HC_ATTR_SEQ m07000_m04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m07000_m08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m07000_m16 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m07000_s04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m07000_s08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m07000_s16 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
