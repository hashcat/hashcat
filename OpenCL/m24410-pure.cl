...
KERNEL_FQ void HC_ATTR_SEQ m24410_init (KERN_ATTR_TMPS_ESALT (pkcs_sha1_tmp_t, pkcs_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m24410_loop (KERN_ATTR_TMPS_ESALT (pkcs_sha1_tmp_t, pkcs_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m24410_comp (KERN_ATTR_TMPS_ESALT (pkcs_sha1_tmp_t, pkcs_t))
{
  const u64 gid = get_global_id (0);
