...
KERNEL_FQ void m33700_init (KERN_ATTR_TMPS_ESALT (pkcs_sha256_tmp_t, pkcs_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m33700_loop (KERN_ATTR_TMPS_ESALT (pkcs_sha256_tmp_t, pkcs_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void m33700_comp (KERN_ATTR_TMPS_ESALT (pkcs_sha256_tmp_t, pkcs_t))
{
  const u64 gid = get_global_id (0);
