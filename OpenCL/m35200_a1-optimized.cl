...
KERNEL_FQ KERNEL_FA void m35200_m04 (KERN_ATTR_BASIC ())
{
  ...
  salt_buf2[2] = salt_bufs[SALT_POS_HOST].salt_buf_pc[10];
  salt_buf2[3] = salt_bufs[SALT_POS_HOST].salt_buf_pc[11];
  salt_buf3[0] = salt_bufs[SALT_POS_HOST].salt_buf_pc[12];
  salt_buf3[1] = salt_bufs[SALT_POS_HOST].salt_buf_pc[13];
  salt_buf3[2] = salt_bufs[SALT_POS_HOST].salt_buf_pc[14];
...
KERNEL_FQ KERNEL_FA void m35200_m08 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ KERNEL_FA void m35200_m16 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ KERNEL_FA void m35200_s04 (KERN_ATTR_BASIC ())
{
  const u64 lid = get_local_id (0);
  const u64 gid = get_global_id (0);
...
KERNEL_FQ KERNEL_FA void m35200_s08 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ KERNEL_FA void m35200_s16 (KERN_ATTR_BASIC ())
{
}
