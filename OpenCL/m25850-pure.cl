...
KERNEL_FQ void FIXED_THREAD_COUNT(FIXED_LOCAL_SIZE) m25850_init (KERN_ATTR_TMPS (bcrypt_tmp_t))
{
  ...
  w[10] = uint_to_hex_lower8 ((f >> 24) & 255) <<  0
        | uint_to_hex_lower8 ((f >> 16) & 255) << 16;
  w[11] = uint_to_hex_lower8 ((f >>  8) & 255) <<  0
        | uint_to_hex_lower8 ((f >>  0) & 255) << 16;
  w[12] = uint_to_hex_lower8 ((g >> 24) & 255) <<  0
        | uint_to_hex_lower8 ((g >> 16) & 255) << 16;
  w[13] = uint_to_hex_lower8 ((g >>  8) & 255) <<  0
        | uint_to_hex_lower8 ((g >>  0) & 255) << 16;
  w[14] = uint_to_hex_lower8 ((h >> 24) & 255) <<  0
        | uint_to_hex_lower8 ((h >> 16) & 255) << 16;
  w[15] = uint_to_hex_lower8 ((h >>  8) & 255) <<  0
