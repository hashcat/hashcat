...
DECLSPEC void m29200m (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (radmin3_t))
{
  /**
  ...
  salt2_buf0[0] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 0];
  salt2_buf0[1] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 1];
  salt2_buf0[2] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 2];
  salt2_buf0[3] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 3];
  salt2_buf1[0] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 4];
  salt2_buf1[1] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 5];
  salt2_buf1[2] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 6];
  salt2_buf1[3] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 7];
  salt2_buf2[0] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 8];
  salt2_buf2[1] = esalt_bufs[DIGESTS_OFFSET_HOST].user[ 9];
  salt2_buf2[2] = esalt_bufs[DIGESTS_OFFSET_HOST].user[10];
  salt2_buf2[3] = esalt_bufs[DIGESTS_OFFSET_HOST].user[11];
  salt2_buf3[0] = esalt_bufs[DIGESTS_OFFSET_HOST].user[12];
  salt2_buf3[1] = esalt_bufs[DIGESTS_OFFSET_HOST].user[13];
  salt2_buf3[2] = esalt_bufs[DIGESTS_OFFSET_HOST].user[14];
  salt2_buf3[3] = esalt_bufs[DIGESTS_OFFSET_HOST].user[15];

  const u32 salt2_len = esalt_bufs[DIGESTS_OFFSET_HOST].user_len;

  const u32 pw_salt_len = pw_len + salt2_len;
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    switch_buffer_by_offset_be (t0, t1, t2, t3, salt2_len);
...
DECLSPEC void m29200s (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (radmin3_t))
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void m29200_m04 (KERN_ATTR_ESALT (radmin3_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m29200_m08 (KERN_ATTR_ESALT (radmin3_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m29200_m16 (KERN_ATTR_ESALT (radmin3_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m29200_s04 (KERN_ATTR_ESALT (radmin3_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m29200_s08 (KERN_ATTR_ESALT (radmin3_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m29200_s16 (KERN_ATTR_ESALT (radmin3_t))
{
  /**
   * base
   */
