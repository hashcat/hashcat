...
KERNEL_FQ void HC_ATTR_SEQ m06800_init (KERN_ATTR_TMPS_ESALT (lastpass_tmp_t, lastpass_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m06800_loop (KERN_ATTR_TMPS_ESALT (lastpass_tmp_t, lastpass_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m06800_comp (KERN_ATTR_TMPS_ESALT (lastpass_tmp_t, lastpass_t))
{
  const u64 gid = get_global_id (0);
