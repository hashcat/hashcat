...
__kernel void m06600_init (KERN_ATTR_TMPS (agilekey_tmp_t))
{
  /**
   * base
   */
...
__kernel void m06600_loop (KERN_ATTR_TMPS (agilekey_tmp_t))
{
  const u64 gid = get_global_id (0);
...
__kernel void m06600_comp (KERN_ATTR_TMPS (agilekey_tmp_t))
{
  const u64 gid = get_global_id (0);
