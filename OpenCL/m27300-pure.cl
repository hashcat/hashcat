...
KERNEL_FQ void HC_ATTR_SEQ m27300_init (KERN_ATTR_TMPS_ESALT (hmac_sha512_tmp_t, snmpv3_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m27300_comp (KERN_ATTR_TMPS_ESALT (hmac_sha512_tmp_t, snmpv3_t))
{
  /**
   * modifier
   */
