...
KERNEL_FQ void HC_ATTR_SEQ m27200_m04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
  ...
  const u32 salt_len = 44; //salt_bufs[SALT_POS_HOST].salt_len;
...
KERNEL_FQ void HC_ATTR_SEQ m27200_m08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void HC_ATTR_SEQ m27200_m16 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void HC_ATTR_SEQ m27200_s04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m27200_s08 (KERN_ATTR_RULES ())
{
}
