...
KERNEL_FQ void m73000_init (KERN_ATTR_TMPS (generic_io_tmp_t))
{
...
KERNEL_FQ void m73000_loop (KERN_ATTR_TMPS (generic_io_tmp_t))
{
}

KERNEL_FQ void m73000_comp (KERN_ATTR_TMPS (generic_io_tmp_t))
{
  /**
   * base
   */
