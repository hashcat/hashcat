...
KERNEL_FQ void HC_ATTR_SEQ m28900_init (KERN_ATTR_TMPS_ESALT (krb5db_18_tmp_t, krb5db_18_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m28900_loop (KERN_ATTR_TMPS_ESALT (krb5db_18_tmp_t, krb5db_18_t))
{
   /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m28900_comp (KERN_ATTR_TMPS_ESALT (krb5db_18_tmp_t, krb5db_18_t))
{
  /**
   * base
   */
