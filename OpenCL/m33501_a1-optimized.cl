...
KERNEL_FQ void HC_ATTR_SEQ m33501_m04 (KERN_ATTR_ESALT (rc4_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m33501_m08 (KERN_ATTR_ESALT (rc4_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m33501_m16 (KERN_ATTR_ESALT (rc4_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m33501_s04 (KERN_ATTR_ESALT (rc4_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m33501_s08 (KERN_ATTR_ESALT (rc4_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m33501_s16 (KERN_ATTR_ESALT (rc4_t))
{
}
