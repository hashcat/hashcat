...
DECLSPEC void m20710m (PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR (), LOCAL_AS u32 *l_bin2asc)
{
  /**
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    wa_t = uint_to_hex_lower8_le ((f >> 16) & 255) <<  0 | uint_to_hex_lower8_le ((f >> 24) & 255) << 16;
    wb_t = uint_to_hex_lower8_le ((f >>  0) & 255) <<  0 | uint_to_hex_lower8_le ((f >>  8) & 255) << 16;
    wc_t = uint_to_hex_lower8_le ((g >> 16) & 255) <<  0 | uint_to_hex_lower8_le ((g >> 24) & 255) << 16;
    wd_t = uint_to_hex_lower8_le ((g >>  0) & 255) <<  0 | uint_to_hex_lower8_le ((g >>  8) & 255) << 16;
    we_t = uint_to_hex_lower8_le ((h >> 16) & 255) <<  0 | uint_to_hex_lower8_le ((h >> 24) & 255) << 16;
    wf_t = uint_to_hex_lower8_le ((h >>  0) & 255) <<  0 | uint_to_hex_lower8_le ((h >>  8) & 255) << 16;
    ...
    // sha256_update: ctx_len 64, pos 0, len = salt_len
...
DECLSPEC void m20710s (PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR (), LOCAL_AS u32 *l_bin2asc)
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void HC_ATTR_SEQ m20710_m04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m20710_m08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m20710_m16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m20710_s04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m20710_s08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m20710_s16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
