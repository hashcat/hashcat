...
#define SIPHASHM_3 0x7465646279746573
   ...
   * bcrypt Constants
   */
typedef enum bcrypt_constants_{
...
typedef enum SHA256_constants_ {
...
typedef enum RIPEMD160_constants_ {
...
typedef enum MYSQL323_constants_ {
  MYSQL323_A=0x50305735,
  MYSQL323_B=0x12345671
} MYSQL323_constants;
