...
KERNEL_FQ void HC_ATTR_SEQ m14700_init (KERN_ATTR_TMPS_ESALT (pbkdf2_sha1_tmp_t, itunes_backup_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m14700_loop (KERN_ATTR_TMPS_ESALT (pbkdf2_sha1_tmp_t, itunes_backup_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m14700_comp (KERN_ATTR_TMPS_ESALT (pbkdf2_sha1_tmp_t, itunes_backup_t))
{
  const u64 gid = get_global_id (0);
