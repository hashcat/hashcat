...
DECLSPEC void m01730m (PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
...
DECLSPEC void m01730s (PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void HC_ATTR_SEQ m01730_m04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m01730_m16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m01730_s04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m01730_s08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m01730_s16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
