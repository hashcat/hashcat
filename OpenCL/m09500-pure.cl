...
KERNEL_FQ void HC_ATTR_SEQ m09500_init (KERN_ATTR_TMPS_ESALT (office2010_tmp_t, office2010_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m09500_loop (KERN_ATTR_TMPS_ESALT (office2010_tmp_t, office2010_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m09500_comp (KERN_ATTR_TMPS_ESALT (office2010_tmp_t, office2010_t))
{
  const u64 gid = get_global_id (0);
