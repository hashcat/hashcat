...
DECLSPEC u32x crc32c (const u32x *w, const u32 pw_len, const u32 iv)
{
  u32x a = ~iv;
...
DECLSPEC void m27900m (u32 *w, const u32 pw_len, KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
...
DECLSPEC void m27900s (u32 *w, const u32 pw_len, KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
