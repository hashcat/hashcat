...
KERNEL_FQ void HC_ATTR_SEQ m10400_m04 (KERN_ATTR_RULES_ESALT (pdf_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m10400_m08 (KERN_ATTR_RULES_ESALT (pdf_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m10400_m16 (KERN_ATTR_RULES_ESALT (pdf_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m10400_s04 (KERN_ATTR_RULES_ESALT (pdf_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m10400_s08 (KERN_ATTR_RULES_ESALT (pdf_t))
{
}

KERNEL_FQ void HC_ATTR_SEQ m10400_s16 (KERN_ATTR_RULES_ESALT (pdf_t))
{
}
