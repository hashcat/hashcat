...
DECLSPEC bool pcfg_keccak384 (PRIVATE_AS const u32 *w, PRIVATE_AS u32 *dgst)
{
...
DECLSPEC bool pcfg_hash (MAYBE_UNUSED PRIVATE_AS const pcfg_hash_ctx_t *hc, PRIVATE_AS u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  ...
  pcfg_put_byte (t, len, 0x01);

  return pcfg_keccak384 (t, dgst);
}
...
#define PCFG_KERNEL_MXX m17900_mxx
#define PCFG_KERNEL_SXX m17900_sxx
