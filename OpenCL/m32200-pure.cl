...
KERNEL_FQ void HC_ATTR_SEQ m32200_init (KERN_ATTR_TMPS_ESALT (krb5asrep_18_tmp_t, krb5asrep_18_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32200_loop (KERN_ATTR_TMPS_ESALT (krb5asrep_18_tmp_t, krb5asrep_18_t))
{
   /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m32200_comp (KERN_ATTR_TMPS_ESALT (krb5asrep_18_tmp_t, krb5asrep_18_t))
{
  /**
   * base
   */
