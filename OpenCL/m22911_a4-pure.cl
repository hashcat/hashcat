...
DECLSPEC bool pcfg_hash (PRIVATE_AS const pcfg_hash_ctx_t *hc, PRIVATE_AS u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  ...
  _des_crypt_decrypt (p1,  hc->enc, K4, K5, s_SPtrans);
  ...
  _des_crypt_decrypt (p1,  hc->first_data, K4, K5, s_SPtrans);
  _des_crypt_encrypt (p2,  p1,  K2, K3, s_SPtrans);
  _des_crypt_decrypt (dec, p2,  K0, K1, s_SPtrans);
...
#define PCFG_KERNEL_MXX m22911_mxx
#define PCFG_KERNEL_SXX m22911_sxx
