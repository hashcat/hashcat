...
KERNEL_FQ void HC_ATTR_SEQ m31200_init (KERN_ATTR_TMPS_ESALT (pbkdf2_sha1_tmp_t, veeam_vbk_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m31200_loop (KERN_ATTR_TMPS_ESALT (pbkdf2_sha1_tmp_t, veeam_vbk_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void HC_ATTR_SEQ m31200_comp (KERN_ATTR_TMPS_ESALT (pbkdf2_sha1_tmp_t, veeam_vbk_t))
{
  const u64 gid = get_global_id (0);
