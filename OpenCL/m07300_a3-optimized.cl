...
DECLSPEC static void m07300m (u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_ESALT (rakp_t))
{
  /**
   * modifier
   */
...
DECLSPEC static void m07300s (u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_ESALT (rakp_t))
{
  /**
   * modifier
   */
