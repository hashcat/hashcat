...
KERNEL_FQ void HC_ATTR_SEQ m02100_init (KERN_ATTR_TMPS (dcc2_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m02100_loop (KERN_ATTR_TMPS (dcc2_tmp_t))
{
  /**
   * base
   */
...
KERNEL_FQ void HC_ATTR_SEQ m02100_comp (KERN_ATTR_TMPS (dcc2_tmp_t))
{
  /**
   * base
   */
