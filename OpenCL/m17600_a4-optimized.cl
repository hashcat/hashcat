...
#define PCFG_SHA3_512_MAXLEN 31
...
DECLSPEC bool pcfg_sha3_512 (PRIVATE_AS const u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  u32 w0[4];
  u32 w1[4];
...
{
  if (len > PCFG_SHA3_512_MAXLEN) return false;

  return pcfg_sha3_512 (w, len, dgst);
}
...
DECLSPEC bool pcfg_hash_global (MAYBE_UNUSED PRIVATE_AS const pcfg_hash_ctx_t *hc, GLOBAL_AS const u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  ...
  return pcfg_sha3_512 (t, len, dgst);
}

#define PCFG_KERNEL_MXX m17600_mxx
#define PCFG_KERNEL_SXX m17600_sxx
