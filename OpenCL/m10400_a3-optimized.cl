...
__kernel void m10400_m04 (KERN_ATTR_ESALT (pdf_t))
{
  /**
   * base
   */
...
__kernel void m10400_m08 (KERN_ATTR_ESALT (pdf_t))
{
  /**
   * base
   */
...
__kernel void m10400_m16 (KERN_ATTR_ESALT (pdf_t))
{
  /**
   * base
   */
...
__kernel void m10400_s04 (KERN_ATTR_ESALT (pdf_t))
{
  /**
   * base
   */
...
__kernel void m10400_s08 (KERN_ATTR_ESALT (pdf_t))
{
  /**
   * base
   */
...
__kernel void m10400_s16 (KERN_ATTR_ESALT (pdf_t))
{
  /**
   * base
   */
