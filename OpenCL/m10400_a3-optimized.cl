...
DECLSPEC static void m10400m (LOCAL_AS RC4_KEY *rc4_keys, u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_ESALT (pdf_t))
{
  /**
   * modifier
   */
...
DECLSPEC static void m10400s (LOCAL_AS RC4_KEY *rc4_keys, u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_ESALT (pdf_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m10400_m04 (KERN_ATTR_ESALT (pdf_t))
{
  /**
   * base
   */
