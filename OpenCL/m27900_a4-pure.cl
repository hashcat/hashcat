...
{
  hc->iv = salt_bufs[salt_pos].salt_buf[0];
}
...
DECLSPEC bool pcfg_hash_global (PRIVATE_AS const pcfg_hash_ctx_t *hc, GLOBAL_AS const u32 *w, const u32 len, PRIVATE_AS u32 *dgst)
{
  ...
  dgst[0] = crc32c_global (w, len, hc->iv);
  dgst[1] = 0;
  dgst[2] = 0;
  dgst[3] = 0;
...
#define PCFG_KERNEL_MXX m27900_mxx
#define PCFG_KERNEL_SXX m27900_sxx
