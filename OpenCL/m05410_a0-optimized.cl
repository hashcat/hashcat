...
KERNEL_FQ KERNEL_FA void m05410_m04 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ KERNEL_FA void m05410_m08 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
}

KERNEL_FQ KERNEL_FA void m05410_m16 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
}

KERNEL_FQ KERNEL_FA void m05410_s04 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ KERNEL_FA void m05410_s08 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
}

KERNEL_FQ KERNEL_FA void m05410_s16 (KERN_ATTR_RULES_ESALT (ikepsk_t))
{
}
