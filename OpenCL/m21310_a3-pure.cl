...
KERNEL_FQ void HC_ATTR_SEQ m21310_mxx (KERN_ATTR_VECTOR_ESALT (md5_double_salt))
{
  /**
   * modifier
   */
...
KERNEL_FQ void HC_ATTR_SEQ m21310_sxx (KERN_ATTR_VECTOR_ESALT (md5_double_salt))
{
  /**
   * modifier
   */
