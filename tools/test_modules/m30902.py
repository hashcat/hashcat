...
# Raw secp256k1 private key (64 hex chars) -> P2PKH legacy address (1...), uncompressed public key.
...
def _legacy_addr(pub):
  return _b58check_enc(b"\x00" + _hash160(pub))
...
def module_generate_hash(word, salt=None, iterations=None):
  ...
  return _legacy_addr(_pub_ser(k, False))
