...
# RSA/DSA/EC/OpenSSH private key, PEM. cid 1/3 is AES-128 CBC, key is a single-round OpenSSL EVP_BytesToKey MD5 (16 bytes), iv is the salt.
...
def generate_key(word, salt_bin):
  ...
  return hashlib.md5(word + salt8).digest()[:16]
