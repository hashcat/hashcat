...
# Bitcoin WIF (uncompressed) -> P2WPKH bech32 (segwit) address. A P2WPKH output that commits to an
# uncompressed key cannot be spent, so this address is one nobody makes on purpose; the mode exists
# to find the key behind it, and the address is built the way the perl witness_program path builds
# it, from hash160 of the uncompressed public key.
