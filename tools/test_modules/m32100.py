...
# Kerberos 5 AS-REP with AES128-CTS-HMAC-SHA1-96 (etype 17). The key is derived with
...
CLEARTEXT_TICKET = (
  "7981df3081dca01b3019a003020111a1120410e2aa1c894df7"
...
def module_generate_hash(word, salt=None, iterations=None, user="user", realm="example.com",
  ...
  if edata2 is not None:
    ...
    # The perl oracle's first clause carries a stray unary minus on the other two, so only this
    # clause can make the check pass. It always does here, since the ticket decrypts to 7981..30.
    check_correct = (t[32:36] in ("7981", "7a81")) and (t[38:40] == "30")
