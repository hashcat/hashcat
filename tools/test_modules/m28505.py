...
# Bitcoin WIF (compressed) -> P2SH(P2WPKH) "compat" address. The password is a 52 character WIF
# private key, the hash is the 3... address that wraps its P2WPKH redeem script.
...
def module_generate_hash(word, salt=None, iterations=None):
  ...
  return _compat_addr(_pub_ser(k, True))
