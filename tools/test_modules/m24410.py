...
# PKCS8 private key, PBKDF2-HMAC-SHA1 key derivation ($PEM$1). cid selects the CBC cipher and key
...
def _pbkdf2(word, salt_bin, iterations, key_len):
  return hashlib.pbkdf2_hmac("sha1", word, salt_bin, iterations, key_len)
