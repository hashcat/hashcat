...
__device__ __constant__ u32 te1[256] =
{
...
__device__ __constant__ u32 te2[256] =
{
...
__device__ __constant__ u32 te3[256] =
{
...
__device__ __constant__ u32 te4[256] =
{
...
__device__ __constant__ u32 td0[256] =
{
...
__device__ __constant__ u32 td1[256] =
{
...
__device__ __constant__ u32 td2[256] =
{
...
__device__ __constant__ u32 td3[256] =
{
...
__device__ __constant__ u32 td4[256] =
{
...
__device__ __constant__ u32 rcon[] =
{
...
__device__ static void AES128_ExpandKey (u32 *userkey, u32 *rek, u32 s_te0[256], u32 s_te1[256], u32 s_te2[256], u32 s_te3[256], u32 s_te4[256])
{
  rek[0] = userkey[0];
  rek[1] = userkey[1];
  rek[2] = userkey[2];
...
__device__ static void AES128_InvertKey (u32 *rdk, u32 s_td0[256], u32 s_td1[256], u32 s_td2[256], u32 s_td3[256], u32 s_td4[256], u32 s_te0[256], u32 s_te1[256], u32 s_te2[256], u32 s_te3[256], u32 s_te4[256])
{
...
__device__ static void AES128_decrypt (const u32 *in, u32 *out, const u32 *rdk, u32 s_td0[256], u32 s_td1[256], u32 s_td2[256], u32 s_td3[256], u32 s_td4[256])
{
  u32 s0 = in[0] ^ rdk[0];
  u32 s1 = in[1] ^ rdk[1];
  u32 s2 = in[2] ^ rdk[2];
...
__device__ static void AES256_ExpandKey (u32 *userkey, u32 *rek, u32 s_te0[256], u32 s_te1[256], u32 s_te2[256], u32 s_te3[256], u32 s_te4[256])
{
  rek[0] = userkey[0];
  rek[1] = userkey[1];
  rek[2] = userkey[2];
...
__device__ static void AES256_InvertKey (u32 *rdk, u32 s_td0[256], u32 s_td1[256], u32 s_td2[256], u32 s_td3[256], u32 s_td4[256], u32 s_te0[256], u32 s_te1[256], u32 s_te2[256], u32 s_te3[256], u32 s_te4[256])
{
...
__device__ static void AES256_decrypt (const u32 *in, u32 *out, const u32 *rdk, u32 s_td0[256], u32 s_td1[256], u32 s_td2[256], u32 s_td3[256], u32 s_td4[256])
{
  u32 s0 = in[0] ^ rdk[0];
  u32 s1 = in[1] ^ rdk[1];
  u32 s2 = in[2] ^ rdk[2];
...
__device__ static void AES256_encrypt (const u32 *in, u32 *out, const u32 *rek, u32 s_te0[256], u32 s_te1[256], u32 s_te2[256], u32 s_te3[256], u32 s_te4[256])
{
  u32 s0 = in[0] ^ rek[0];
  u32 s1 = in[1] ^ rek[1];
  u32 s2 = in[2] ^ rek[2];
...
extern "C" __global__ void __launch_bounds__ (256, 1) m08800_comp (const pw_t *pws, const gpu_rule_t *rules_buf, const comb_t *combs_buf, const bf_t *bfs_buf, androidfde_tmp_t *tmps, void *hooks, const u32 *bitmaps_buf_s1_a, const u32 *bitmaps_buf_s1_b, const u32 *bitmaps_buf_s1_c, const u32 *bitmaps_buf_s1_d, const u32 *bitmaps_buf_s2_a, const u32 *bitmaps_buf_s2_b, const u32 *bitmaps_buf_s2_c, const u32 *bitmaps_buf_s2_d, plain_t *plains_buf, const digest_t *digests_buf, u32 *hashes_shown, const salt_t *salt_bufs, const androidfde_t *androidfde_bufs, u32 *d_return_buf, u32 *d_scryptV_buf, const u32 bitmap_mask, const u32 bitmap_shift1, const u32 bitmap_shift2, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u32 rules_cnt, const u32 digests_cnt, const u32 digests_offset, const u32 combs_mode, const u32 gid_max)
{
  ...
  ukeyx[0] = tmps[gid].out[0];
  ukeyx[1] = tmps[gid].out[1];
  ukeyx[2] = tmps[gid].out[2];
  ukeyx[3] = tmps[gid].out[3];
  ukeyx[4] = 0;
  ukeyx[5] = 0;
  ukeyx[6] = 0;
  ukeyx[7] = 0;
  ...
  for (u32 i = 0; i < 44; i++) rdk[i] = rek[i];
  ...
  /**
   * section AES_cbc_essiv() starting
   */

  // 1. start with simple sha256_transform
...

  {
    ...
    AES256_encrypt (data, essiv, rek, s_te0, s_te1, s_te2, s_te3, s_te4);
    ...
    {
      mark_hash_s0 (plains_buf, hashes_shown, digests_offset + 0, gid, 0);
