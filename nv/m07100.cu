...
__device__ static void hmac_run (const u64 w1[16], const u64 ipad[8], const u64 opad[8], u64 dgst[8])
{
  dgst[0] = ipad[0];
  dgst[1] = ipad[1];
  dgst[2] = ipad[2];
...
__device__ static void hmac_init (u64 w[16], u64 ipad[8], u64 opad[8])
{
