...
__device__ __constant__ entry_t pc[1024] =
{
...
__device__ static void append_word (u32x w0[4], u32x w1[4], const u32x append[4], const u32 offset)
{
  switch (offset)
  {
    case 1:
...
__device__ static void append_salt (u32x w0[4], u32x w1[4], u32x w2[4], const u32 append[5], const u32 offset)
{
  switch (offset)
  {
    case 2:
...
extern "C" __global__ void __launch_bounds__ (256, 1) m05800_loop (const pw_t *pws, const gpu_rule_t *rules_buf, const comb_t *combs_buf, const bf_t *bfs_buf, androidpin_tmp_t *tmps, void *hooks, const u32 *bitmaps_buf_s1_a, const u32 *bitmaps_buf_s1_b, const u32 *bitmaps_buf_s1_c, const u32 *bitmaps_buf_s1_d, const u32 *bitmaps_buf_s2_a, const u32 *bitmaps_buf_s2_b, const u32 *bitmaps_buf_s2_c, const u32 *bitmaps_buf_s2_d, plain_t *plains_buf, const digest_t *digests_buf, u32 *hashes_shown, const salt_t *salt_bufs, const void *esalt_bufs, u32 *d_return_buf, u32 *d_scryptV_buf, const u32 bitmap_mask, const u32 bitmap_shift1, const u32 bitmap_shift2, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u32 rules_cnt, const u32 digests_cnt, const u32 digests_offset, const u32 combs_mode, const u32 gid_max)
{
  ...
  __shared__ entry_t s_pc[1024];

  const u32 lid4 = lid * 4;

  s_pc[lid4 + 0] = pc[lid4 + 0];
  s_pc[lid4 + 1] = pc[lid4 + 1];
  s_pc[lid4 + 2] = pc[lid4 + 2];
  s_pc[lid4 + 3] = pc[lid4 + 3];
