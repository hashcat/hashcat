...
__device__ __constant__ u32 c_tables[4][256] =
{
  {
...
extern "C" __global__ void __launch_bounds__ (256, 1) m06900_m04 (const pw_t *pws, const gpu_rule_t *rules_buf, const comb_t *combs_buf, const bf_t *bfs_buf, const void *tmps, void *hooks, const u32 *bitmaps_buf_s1_a, const u32 *bitmaps_buf_s1_b, const u32 *bitmaps_buf_s1_c, const u32 *bitmaps_buf_s1_d, const u32 *bitmaps_buf_s2_a, const u32 *bitmaps_buf_s2_b, const u32 *bitmaps_buf_s2_c, const u32 *bitmaps_buf_s2_d, plain_t *plains_buf, const digest_t *digests_buf, u32 *hashes_shown, const salt_t *salt_bufs, const void *esalt_bufs, u32 *d_return_buf, u32 *d_scryptV_buf, const u32 bitmap_mask, const u32 bitmap_shift1, const u32 bitmap_shift2, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u32 rules_cnt, const u32 digests_cnt, const u32 digests_offset, const u32 combs_mode, const u32 gid_max)
{
  ...
  __shared__ u32 s_tables[4][256];

  s_tables[0][lid] = c_tables[0][lid];
  s_tables[1][lid] = c_tables[1][lid];
  s_tables[2][lid] = c_tables[2][lid];
  s_tables[3][lid] = c_tables[3][lid];
  ...
  for (u32 il_pos = 0; il_pos < rules_cnt; il_pos++)
  {
    ...
    const u32x r0 = state[0];
    const u32x r1 = state[1];
    const u32x r2 = state[2];
    const u32x r3 = state[3];
