...
__device__ static void aes256_ExpandKey (u32 *ks, const u32 *ukey)
{
  ks[0] = ukey[0];
  ks[1] = ukey[1];
  ks[2] = ukey[2];
...
__device__ static void aes256_set_encrypt_key (u32 *ks, const u32 *ukey)
{
  u32 ukey_s[8];
...
__device__ static void aes256_set_decrypt_key (u32 *ks, const u32 *ukey)
{
  u32 ukey_s[8];
...
__device__ static void aes256_decrypt (const u32 *ks, const u32 *in, u32 *out)
{
  u32 in_s[4];
...
__device__ static void aes256_encrypt (const u32 *ks, const u32 *in, u32 *out)
{
  u32 in_s[4];
...
__device__ static void aes256_decrypt_xts (const u32 *ukey1, const u32 *ukey2, const u32 *in, u32 *out)
{
  u32 T[4] = { 0 };
  u32 Z[4] = { 0 };
