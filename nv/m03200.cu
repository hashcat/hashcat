...
__device__ __constant__ u32 c_sbox0[256] =
{
...
__device__ __constant__ u32 c_sbox1[256] =
{
...
__device__ __constant__ u32 c_sbox2[256] =
{
...
__device__ __constant__ u32 c_sbox3[256] =
{
...
__device__ __constant__ u32 c_pbox[18] =
{
...
__device__ static void expand_key (u32x E[34], const u32x W[16], const u32 len)
{
  u8 *E_cur  = (u8 *) E;
  u8 *E_stop = E_cur + 72;
...
extern "C" __global__ void __launch_bounds__ (8, 1) m03200_init (const pw_t *pws, const gpu_rule_t *rules_buf, const comb_t *combs_buf, const bf_t *bfs_buf, bcrypt_tmp_t *tmps, void *hooks, const u32 *bitmaps_buf_s1_a, const u32 *bitmaps_buf_s1_b, const u32 *bitmaps_buf_s1_c, const u32 *bitmaps_buf_s1_d, const u32 *bitmaps_buf_s2_a, const u32 *bitmaps_buf_s2_b, const u32 *bitmaps_buf_s2_c, const u32 *bitmaps_buf_s2_d, plain_t *plains_buf, const digest_t *digests_buf, u32 *hashes_shown, const salt_t *salt_bufs, const void *esalt_bufs, u32 *d_return_buf, u32 *d_scryptV_buf, const u32 bitmap_mask, const u32 bitmap_shift1, const u32 bitmap_shift2, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u32 rules_cnt, const u32 digests_cnt, const u32 digests_offset, const u32 combs_mode, const u32 gid_max)
{
  ...
  __shared__ u32x S0_all[8][256];
  __shared__ u32x S1_all[8][256];
  __shared__ u32x S2_all[8][256];
  __shared__ u32x S3_all[8][256];
