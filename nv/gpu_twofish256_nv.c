...
__device__ __constant__ u32 q_tab[2][256] =
{
  {
...
__device__ __constant__ u32  m_tab[4][256] =
{
...
__device__ static u32 h_fun (u32 *sk, u32 *lk, const u32 x, const u32 *key)
{
  u32  b0, b1, b2, b3;
...
__device__ static u32 mds_rem (u32 p0, u32 p1)
{
  #define G_MOD 0x14d
...
__device__ static void twofish256_set_key (u32 *sk, u32 *lk, const u32 *ukey)
{
  u32 me_key[4];
...
__device__ static void twofish256_encrypt (const u32 *sk, const u32 *lk, const u32 *in, u32 *out)
{
  u32 data[4];
...
__device__ static void twofish256_decrypt (const u32 *sk, const u32 *lk, const u32 *in, u32 *out)
{
  u32 data[4];
...
__device__ static void twofish256_decrypt_xts (const u32 *ukey1, const u32 *ukey2, const u32 *in, u32 *out)
{
  u32 T[4] = { 0 };
  u32 Z[4] = { 0 };
