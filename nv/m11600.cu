...
__device__ static u32 memcat8c (u32x block[16], const u32 block_len, const u32x append[4], const u32 append_len, u32x digest[8])
{
...
__device__ static u32 memcat32c (u32x block[16], const u32 block_len, const u32x append[4], const u32 append_len, u32x digest[8])
{
  const u32 div = block_len / 4;
