...
typedef enum opti_type
{
  ...
  OPTI_TYPE_OPTIMIZED_KERNEL_ONLY = (1 <<  1),
  OPTI_TYPE_ZERO_BYTE             = (1 <<  2),
  OPTI_TYPE_PRECOMPUTE_INIT       = (1 <<  3),
  ...
  OPTI_TYPE_REGISTER_LIMIT        = (1 << 21), // We'll limit the register count to 128
  OPTI_TYPE_SLOW_HASH_SIMD_INIT2  = (1 << 22),
  OPTI_TYPE_SLOW_HASH_SIMD_LOOP2  = (1 << 23),
