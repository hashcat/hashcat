...
typedef struct NV_GPU_PERF_POLICIES_INFO_PARAMS_V1_
{
...
typedef struct NV_GPU_PERF_POLICIES_STATUS_PARAMS_V1_
{
...
typedef struct NV_GPU_COOLER_LEVELS_
{
  NvU32    Version;
...
typedef NvAPI_Status(*NVAPI_API_CALL NVAPI_INITIALIZE) (void);
typedef NvAPI_Status(*NVAPI_API_CALL NVAPI_UNLOAD) (void);
typedef int(*NVAPI_API_CALL NVAPI_GETERRORMESSAGE) (NvAPI_Status, NvAPI_ShortString);
typedef NvAPI_Status(*NVAPI_API_CALL NVAPI_ENUMPHYSICALGPUS) (NvPhysicalGpuHandle nvGPUHandle[NVAPI_MAX_PHYSICAL_GPUS], NvU32 *);
typedef NvAPI_Status(*NVAPI_API_CALL NVAPI_GPU_GETPERFPOLICIESINFO) (NvPhysicalGpuHandle, NV_GPU_PERF_POLICIES_INFO_PARAMS_V1 *);
typedef NvAPI_Status(*NVAPI_API_CALL NVAPI_GPU_GETPERFPOLICIESSTATUS) (NvPhysicalGpuHandle, NV_GPU_PERF_POLICIES_STATUS_PARAMS_V1 *);
typedef NvAPI_Status(*NVAPI_API_CALL NVAPI_GPU_SETCOOLERLEVELS) (NvPhysicalGpuHandle, NvU32, NV_GPU_COOLER_LEVELS *);
typedef NvAPI_Status(*NVAPI_API_CALL NVAPI_GPU_RESTORECOOLERSETTINGS) (NvPhysicalGpuHandle, NvU32);

typedef struct hm_nvapi_lib_t_
{
  NVAPI_LIB lib;
