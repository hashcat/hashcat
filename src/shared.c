...
static const AUTO PA_000 = "OK";
static const AUTO PA_001 = "Ignored due to comment";
static const AUTO PA_002 = "Ignored due to zero length";
static const AUTO PA_003 = "Line-length exception";
static const AUTO PA_004 = "Hash-length exception";
static const AUTO PA_005 = "Hash-value exception";
static const AUTO PA_006 = "Salt-length exception";
static const AUTO PA_007 = "Salt-value exception";
static const AUTO PA_008 = "Salt-iteration count exception";
static const AUTO PA_009 = "Separator unmatched";
static const AUTO PA_010 = "Signature unmatched";
static const AUTO PA_011 = "Invalid hccapx file size";
static const AUTO PA_012 = "Invalid hccapx eapol size";
static const AUTO PA_013 = "Invalid psafe2 filesize";
static const AUTO PA_014 = "Invalid psafe3 filesize";
static const AUTO PA_015 = "Invalid truecrypt filesize";
static const AUTO PA_016 = "Invalid veracrypt filesize";
static const AUTO PA_017 = "Invalid SIP directive, only MD5 is supported";
static const AUTO PA_018 = "Hash-file exception";
static const AUTO PA_019 = "Hash-encoding exception";
static const AUTO PA_020 = "Salt-encoding exception";
static const AUTO PA_021 = "Invalid LUKS filesize";
static const AUTO PA_022 = "Invalid LUKS identifier";
static const AUTO PA_023 = "Invalid LUKS version";
static const AUTO PA_024 = "Invalid or unsupported LUKS cipher type";
static const AUTO PA_025 = "Invalid or unsupported LUKS cipher mode";
static const AUTO PA_026 = "Invalid or unsupported LUKS hash type";
static const AUTO PA_027 = "Invalid LUKS key size";
static const AUTO PA_028 = "Disabled LUKS key detected";
static const AUTO PA_029 = "Invalid LUKS key AF stripes count";
static const AUTO PA_030 = "Invalid combination of LUKS hash type and cipher type";
static const AUTO PA_031 = "Invalid hccapx signature";
static const AUTO PA_032 = "Invalid hccapx version";
static const AUTO PA_033 = "Invalid hccapx message pair";
static const AUTO PA_034 = "Token encoding exception";
static const AUTO PA_035 = "Token length exception";
static const AUTO PA_036 = "Insufficient entropy exception";
static const AUTO PA_037 = "Hash contains unsupported compression type for current mode";
static const AUTO PA_038 = "Invalid key size";
static const AUTO PA_039 = "Invalid block size";
static const AUTO PA_040 = "Invalid or unsupported cipher";
static const AUTO PA_041 = "Invalid filesize";
static const AUTO PA_042 = "IV length exception";
static const AUTO PA_043 = "CT length exception";
static const AUTO PA_255 = "Unknown error";

static const AUTO OPTI_STR_OPTIMIZED_KERNEL     = "Optimized-Kernel";
static const AUTO OPTI_STR_ZERO_BYTE            = "Zero-Byte";
static const AUTO OPTI_STR_PRECOMPUTE_INIT      = "Precompute-Init";
static const AUTO OPTI_STR_MEET_IN_MIDDLE       = "Meet-In-The-Middle";
static const AUTO OPTI_STR_EARLY_SKIP           = "Early-Skip";
static const AUTO OPTI_STR_NOT_SALTED           = "Not-Salted";
static const AUTO OPTI_STR_NOT_ITERATED         = "Not-Iterated";
static const AUTO OPTI_STR_PREPENDED_SALT       = "Prepended-Salt";
static const AUTO OPTI_STR_APPENDED_SALT        = "Appended-Salt";
static const AUTO OPTI_STR_SINGLE_HASH          = "Single-Hash";
static const AUTO OPTI_STR_SINGLE_SALT          = "Single-Salt";
static const AUTO OPTI_STR_BRUTE_FORCE          = "Brute-Force";
static const AUTO OPTI_STR_RAW_HASH             = "Raw-Hash";
static const AUTO OPTI_STR_SLOW_HASH_SIMD_INIT  = "Slow-Hash-SIMD-INIT";
static const AUTO OPTI_STR_SLOW_HASH_SIMD_LOOP  = "Slow-Hash-SIMD-LOOP";
static const AUTO OPTI_STR_SLOW_HASH_SIMD_COMP  = "Slow-Hash-SIMD-COMP";
static const AUTO OPTI_STR_USES_BITS_8          = "Uses-8-Bit";
static const AUTO OPTI_STR_USES_BITS_16         = "Uses-16-Bit";
static const AUTO OPTI_STR_USES_BITS_32         = "Uses-32-Bit";
static const AUTO OPTI_STR_USES_BITS_64         = "Uses-64-Bit";

static const AUTO HASH_CATEGORY_UNDEFINED_STR              = "Undefined";
static const AUTO HASH_CATEGORY_RAW_HASH_STR               = "Raw Hash";
static const AUTO HASH_CATEGORY_RAW_HASH_SALTED_STR        = "Raw Hash, Salted and/or Iterated";
static const AUTO HASH_CATEGORY_RAW_HASH_AUTHENTICATED_STR = "Raw Hash, Authenticated";
static const AUTO HASH_CATEGORY_RAW_CIPHER_KPA_STR         = "Raw Cipher, Known-Plaintext attack";
static const AUTO HASH_CATEGORY_GENERIC_KDF_STR            = "Generic KDF";
static const AUTO HASH_CATEGORY_NETWORK_PROTOCOL_STR       = "Network Protocols";
static const AUTO HASH_CATEGORY_FORUM_SOFTWARE_STR         = "Forums, CMS, E-Commerce";
static const AUTO HASH_CATEGORY_DATABASE_SERVER_STR        = "Database Server";
static const AUTO HASH_CATEGORY_NETWORK_SERVER_STR         = "FTP, HTTP, SMTP, LDAP Server";
static const AUTO HASH_CATEGORY_RAW_CHECKSUM_STR           = "Raw Checksum";
static const AUTO HASH_CATEGORY_OS_STR                     = "Operating System";
static const AUTO HASH_CATEGORY_EAS_STR                    = "Enterprise Application Software (EAS)";
static const AUTO HASH_CATEGORY_ARCHIVE_STR                = "Archives";
static const AUTO HASH_CATEGORY_FDE_STR                    = "Full-Disk Encryption (FDE)";
static const AUTO HASH_CATEGORY_FBE_STR                    = "File-Based Encryption (FBE)";
static const AUTO HASH_CATEGORY_DOCUMENTS_STR              = "Documents";
static const AUTO HASH_CATEGORY_PASSWORD_MANAGER_STR       = "Password Managers";
static const AUTO HASH_CATEGORY_OTP_STR                    = "One-Time Passwords";
static const AUTO HASH_CATEGORY_PLAIN_STR                  = "Plaintext";
static const AUTO HASH_CATEGORY_FRAMEWORK_STR              = "Framework";
static const AUTO HASH_CATEGORY_PRIVATE_KEY_STR            = "Private Key";
static const AUTO HASH_CATEGORY_IMS_STR                    = "Instant Messaging Service";
static const AUTO HASH_CATEGORY_CRYPTOCURRENCY_WALLET_STR  = "Cryptocurrency Wallet";
...
static int rounds_count_length (const char *input_buf, const int input_len)
{
  ...
  {
    static const AUTO rounds = "rounds=";
