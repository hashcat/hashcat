...
static const char *ST_HASH        = "6bc7ad9dfc2eb8ce7d425e1ff914bd157063bc78:hashcat";
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  // Prepend 2 dashes
  memmove(salt_buf_ptr + strlen(dashes), salt_buf_ptr, salt->salt_len+1);
  memcpy(salt_buf_ptr, dashes, strlen(dashes));
  salt->salt_len += strlen(dashes);

  // Append 2 dashes
  memcpy (salt_buf_ptr + salt->salt_len, dashes, strlen(dashes));
  salt->salt_len += strlen(dashes);
