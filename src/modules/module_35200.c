...
static const char *HASH_NAME      = "AS/400 SSHA1";
static const u64   KERN_TYPE      = 35200;
...
static const char *ST_PASS        = "IOIO13";
static const char *ST_HASH        = "$as400$ssha1$*QTEST1*7ED7D3694D0A2E40A720D41031B456C09124966E";
...
static const char *SIGNATURE_AS400_SSHA1 = "$as400$ssha1$";
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  token.signatures_buf[0] = SIGNATURE_AS400_SSHA1;
...
int module_hash_encode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED const void *digest_buf, MAYBE_UNUSED const salt_t *salt, MAYBE_UNUSED const void *esalt_buf, MAYBE_UNUSED const void *hook_salt_buf, MAYBE_UNUSED const hashinfo_t *hash_info, char *line_buf, MAYBE_UNUSED const int line_size)
{
  ...
  char tmp_digest[40 + 1] = { 0 };

  u8 *tmp_buf = (u8 *) tmp_digest;

  int tmp_len = 0;

  u32_to_hex (tmp[0], tmp_buf + tmp_len); tmp_len += 8;
  u32_to_hex (tmp[1], tmp_buf + tmp_len); tmp_len += 8;
  u32_to_hex (tmp[2], tmp_buf + tmp_len); tmp_len += 8;
  u32_to_hex (tmp[3], tmp_buf + tmp_len); tmp_len += 8;
  u32_to_hex (tmp[4], tmp_buf + tmp_len); tmp_len += 8;
  ...
  const int line_len = snprintf (line_buf, line_size, "%s*%s*%s", SIGNATURE_AS400_SSHA1, tmp_salt, tmp_buf);
