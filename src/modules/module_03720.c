...
static const char *HASH_NAME      = "md5($salt.strtoupper(md5($pass)))";
static const u64   KERN_TYPE      = 3720;
...
static const char *ST_HASH        = "3dfb0e588010a021335d988ad28d4038:242812778074";
