...
static const char *HASH_NAME      = "MS Office <= 2003 $3, SHA1 + RC4, collider #1";
static const u64   KERN_TYPE      = 9810;
...
{
  const u32 pw_min = 5; // RC4-40 fixed
...
{
  const u32 pw_max = 5; // RC4-40 fixed
