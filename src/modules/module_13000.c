...
static const char *HASH_NAME      = "RAR5";
static const u64   KERN_TYPE      = 13000;
...
static const char *ST_HASH        = "$rar5$16$38466361001011015181344360681307$15$00000000000000000000000000000000$8$cc7a30583e62676a";
...
{
  const u64 esalt_size = (const u64) sizeof (rar5_t);
...
int module_hash_encode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED const void *digest_buf, MAYBE_UNUSED const salt_t *salt, MAYBE_UNUSED const void *esalt_buf, MAYBE_UNUSED const void *hook_salt_buf, MAYBE_UNUSED const hashinfo_t *hash_info, char *line_buf, MAYBE_UNUSED const int line_size)
{
  ...
  const rar5_t *rar5 = (const rar5_t *) esalt_buf;

  const int line_len = snprintf (line_buf, line_size, "$rar5$16$%08x%08x%08x%08x$%u$%08x%08x%08x%08x$8$%08x%08x",
      salt->salt_buf[0],
      salt->salt_buf[1],
      salt->salt_buf[2],
      salt->salt_buf[3],
