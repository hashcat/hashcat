...
static const char *HASH_NAME      = "Ethereum Wallet, SCRYPT [Bridged: Scrypt-Jane SMix]";
static const u64   KERN_TYPE      = 70400;
...
// Bridge-compatible tmp_size (same as module 70100)
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  // With the scrypt-jane bridge (BRIDGE_TYPE_REPLACE_LOOP), the bridge
  // executes all N ROMix iterations in a single call. The original OpenCL
  // path used salt_iter = N (one iteration per kernel launch). Setting
  // salt_iter = 1 tells hashcat to invoke the bridge exactly once.
  // This matches the pattern used by mode 70100 (generic scrypt bridge).
  salt->salt_iter = 1;
