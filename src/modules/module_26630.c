...
static const char *ST_HASH        = "$metamask-short-iter$jfGI3TXguhb8GPnKSXFrMzRk2NCEc131Gt5G3kZr5+s=$10000$h+BoIf2CQ5BEjaIOShFE7g==$R95fzGt4UQ0uwrcrVYnIi4UcSlWn9wlmer+//526ZDwYAp50K82F1u1oacYcdjjhuEvbZnWk/uBG00UkgLLlOw==";
...
static const char *SIGNATURE_METAMASK_WALLET = "$metamask-short-iter$";
...
int module_hash_encode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED const void *digest_buf, MAYBE_UNUSED const salt_t *salt, MAYBE_UNUSED const void *esalt_buf, MAYBE_UNUSED const void *hook_salt_buf, MAYBE_UNUSED const hashinfo_t *hash_info, char *line_buf, MAYBE_UNUSED const int line_size)
{
  ...
  // iterations
  char iterations[8];
  sprintf(iterations, "%d", salt->salt_iter+1);
