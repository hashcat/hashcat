...
static const char *HASH_NAME      = "sha1(sha1($pass).$salt)";
static const u64   KERN_TYPE      = 4510;
...
static const char *ST_HASH        = "9138d472fce6fe50e2a32da4eec4ecdc8860f4d5:hashcat1";
