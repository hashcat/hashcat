...
static const char *ST_HASH        = "5c80990cd5a2b5817d7cf784de09c3a58c83e8ae:salt";
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  const bool parse_rc1 = generic_salt_decode (hashconfig, token.buf[1], token.len[1], (u8 *) sha1_double_salt->salt2_buf, (int *) &sha1_double_salt->salt2_len);
  ...
  // Prepend 2 dashes
  memmove(salt2_buf_ptr + strlen(dashes), salt2_buf_ptr, sha1_double_salt->salt2_len+1);
  memcpy(salt2_buf_ptr, dashes, strlen(dashes));
  sha1_double_salt->salt2_len += strlen(dashes);
  // Append 2 dashes
  memcpy (salt2_buf_ptr + sha1_double_salt->salt2_len, dashes, strlen(dashes));
  sha1_double_salt->salt2_len += strlen(dashes);
