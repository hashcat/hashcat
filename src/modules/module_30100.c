...
static const char *HASH_NAME      = "Python Werkzeug SHA1 (HMAC-SHA1 (key = $salt))";
// This is identical to mode 160, just a different format
static const u64   KERN_TYPE      = 160;
...
static const char *ST_HASH        = "sha1$2134817$8d7cb4d4a27a438059bb83a34d1e6cc439669168";
...
static const char * SIGNATURE_WERKZEUG_SHA1 = "sha1";
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  token.signatures_buf[0] = SIGNATURE_WERKZEUG_SHA1;
