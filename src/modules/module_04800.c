...
static const char *ST_HASH        = "aa4aaa1d52319525023c06a4873f4c51:35343534373533343633383832343736:dc";
...
{
  return "The hashformat is hash:salt:id";
}
...
int module_hash_encode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED const void *digest_buf, MAYBE_UNUSED const salt_t *salt, MAYBE_UNUSED const void *esalt_buf, MAYBE_UNUSED const void *hook_salt_buf, MAYBE_UNUSED const hashinfo_t *hash_info, char *line_buf, MAYBE_UNUSED const int line_size)
{
  ...
  const u8 chap_id_byte = (const u8) salt->salt_buf[4];

  const int line_len = snprintf (line_buf, line_size, "%08x%08x%08x%08x:%08x%08x%08x%08x:%02x",
    byte_swap_32 (tmp[0]),
    byte_swap_32 (tmp[1]),
    byte_swap_32 (tmp[2]),
    byte_swap_32 (tmp[3]),
