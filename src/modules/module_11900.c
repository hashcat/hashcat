...
static const char *HASH_NAME      = "PBKDF2-HMAC-MD5";
static const u64   KERN_TYPE      = 11900;
...
static const char *ST_HASH        = "md5:1000:NjAxMDY4MQ==:a00DtIW9hP9voC85fmEA5uVhgdDx67nSPSm9yADHjkI=";
...
{
  const u64 esalt_size = (const u64) sizeof (pbkdf2_md5_t);
...
{
  const u64 tmp_size = (const u64) sizeof (pbkdf2_md5_tmp_t);
