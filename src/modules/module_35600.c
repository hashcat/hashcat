...
static const char *HASH_NAME      = "gost12512crypt [$gost12512hash$] (Unix)";
static const u64   KERN_TYPE      = 35600;
...
static const char *ST_HASH        = "$gost12512hash$salt$w0TCvk4n0JHA/kPNpHEyf3RR5YuUXReihlrize3NdcPCmtLk/ewG63OUWT.G4bvjegPTeMb/xQ2PK7apsCfC7/";
...
static const u32   ROUNDS_GOST12512CRYPT    = 5000;
static const char *SIGNATURE_GOST12512CRYPT = "$gost12512hash$";

static void gost12512crypt_decode (u8 digest[64], const u8 buf[86])
{
  int l;
...
static void gost12512crypt_encode (const u8 digest[64], u8 buf[86])
{
  int l;
...
{
  const u64 tmp_size = (const u64) sizeof (gost12512crypt_tmp_t);
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  token.signatures_buf[0] = SIGNATURE_GOST12512CRYPT;
  ...
  salt->salt_iter = ROUNDS_GOST12512CRYPT;
  ...
  gost12512crypt_decode ((u8 *) digest, hash_pos);
...
int module_hash_encode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED const void *digest_buf, MAYBE_UNUSED const salt_t *salt, MAYBE_UNUSED const void *esalt_buf, MAYBE_UNUSED const void *hook_salt_buf, MAYBE_UNUSED const hashinfo_t *hash_info, char *line_buf, MAYBE_UNUSED const int line_size)
{
  ...
  gost12512crypt_encode (digest_buf, tmp);
  ...
  if (salt->salt_iter == ROUNDS_GOST12512CRYPT)
  {
    line_len = snprintf (line_buf, line_size, "$gost12512hash$%s$%s", tmp_salt, tmp);
  }
  else
  {
    line_len = snprintf (line_buf, line_size, "$gost12512hash$rounds=%u$%s$%s", salt->salt_iter, tmp_salt, tmp);
  }
