...
bool sysfs_init (void *hashcat_ctx_0)
{
...
void sysfs_close (void *hashcat_ctx_0)
{
  hashcat_ctx_t *hashcat_ctx = (hashcat_ctx_t *) hashcat_ctx_0;
...
char *hm_SYSFS_get_syspath_device (void *hashcat_ctx_0, const int backend_device_idx)
{
  hashcat_ctx_t *hashcat_ctx = (hashcat_ctx_t *) hashcat_ctx_0;
...
char *hm_SYSFS_get_syspath_hwmon (void *hashcat_ctx_0, const int backend_device_idx)
{
  hashcat_ctx_t *hashcat_ctx = (hashcat_ctx_t *) hashcat_ctx_0;
...
int hm_SYSFS_get_fan_speed_current (void *hashcat_ctx_0, const int backend_device_idx, int *val)
{
  hashcat_ctx_t *hashcat_ctx = (hashcat_ctx_t *) hashcat_ctx_0;
...
int hm_SYSFS_get_temperature_current (void *hashcat_ctx_0, const int backend_device_idx, int *val)
{
  hashcat_ctx_t *hashcat_ctx = (hashcat_ctx_t *) hashcat_ctx_0;
...
int hm_SYSFS_get_pp_dpm_sclk (void *hashcat_ctx_0, const int backend_device_idx, int *val)
{
  hashcat_ctx_t *hashcat_ctx = (hashcat_ctx_t *) hashcat_ctx_0;
  ...
  while (!hc_feof (&fp))
  {
    ...
    if (sscanf (ptr, "%d: %dMHz", &profile, &clockfreq) == 2) break;
  }
...
int hm_SYSFS_get_pp_dpm_mclk (void *hashcat_ctx_0, const int backend_device_idx, int *val)
{
  hashcat_ctx_t *hashcat_ctx = (hashcat_ctx_t *) hashcat_ctx_0;
...
int hm_SYSFS_get_pp_dpm_pcie (void *hashcat_ctx_0, const int backend_device_idx, int *val)
{
  hashcat_ctx_t *hashcat_ctx = (hashcat_ctx_t *) hashcat_ctx_0;
  ...
  while (!hc_feof (&fp))
  {
    ...
    if (sscanf (ptr, "%d: %fGB, x%d *", &profile, &speed, &lanes) == 3) break;
  }
