...
static const AUTO dri_card0_path = "/dev/dri/card0";

static const AUTO drm_card0_vendor_path = "/sys/class/drm/card0/device/vendor";
static const AUTO drm_card0_driver_path = "/sys/class/drm/card0/device/driver";
#endif
