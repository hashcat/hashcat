...
static const char *USAGE_BIG[] =
{
  ...
  "   1310 | sha224($pass.$salt)                              | Raw Hash, Salted and / or Iterated",
  "   1320 | sha224($pass.$salt)                              | Raw Hash, Salted and / or Iterated",
  "   1330 | sha224($pass.$salt)                              | Raw Hash, Salted and / or Iterated",
