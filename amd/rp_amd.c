...
static u32x generate_cmask (u32x buf)
{
...
static void truncate_right (u32x w0[4], u32x w1[4], const u32 len)
{
...
static void truncate_left (u32x w0[4], u32x w1[4], const u32 len)
{
  const u32 tmp = ~((1 << ((len % 4) * 8)) - 1);
...
static void lshift_block (const u32x in0[4], const u32x in1[4], u32x out0[4], u32x out1[4])
{
  /* cuda
...
static void rshift_block (const u32x in0[4], const u32x in1[4], u32x out0[4], u32x out1[4])
{
  /* cuda
...
static void lshift_block_N (const u32x in0[4], const u32x in1[4], u32x out0[4], u32x out1[4], const u32 num)
{
  switch (num)
  {
    case  0:  out0[0] = in0[0];
...
static void rshift_block_N (const u32x in0[4], const u32x in1[4], u32x out0[4], u32x out1[4], const u32 num)
{
  switch (num)
  {
    case  0:  out1[3] = in1[3];
...
static void append_block1 (const u32 offset, u32x dst0[4], u32x dst1[4], const u32x src_r0)
{
  u32x tmp[2];
...
static void append_block8 (const u32 offset, u32x dst0[4], u32x dst1[4], const u32x src_l0[4], const u32x src_l1[4], const u32x src_r0[4], const u32x src_r1[4])
{
  switch (offset)
  {
    case 0:
...
static void reverse_block (u32x in0[4], u32x in1[4], u32x out0[4], u32x out1[4], const u32 len)
{
...
static u32 rule_op_mangle_lrest (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_urest (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  buf0[0] &= ~(generate_cmask (buf0[0]));
  buf0[1] &= ~(generate_cmask (buf0[1]));
  buf0[2] &= ~(generate_cmask (buf0[2]));
...
static u32 rule_op_mangle_lrest_ufirst (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_urest_lfirst (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_trest (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  buf0[0] ^= (generate_cmask (buf0[0]));
  buf0[1] ^= (generate_cmask (buf0[1]));
  buf0[2] ^= (generate_cmask (buf0[2]));
...
static u32 rule_op_mangle_toggle_at (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_reverse (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_dupeword (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_dupeword_times (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_reflect (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if ((in_len + in_len) >= 32) return (in_len);
...
static u32 rule_op_mangle_append (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_prepend (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if ((in_len + 1) >= 32) return (in_len);
...
static u32 rule_op_mangle_rotate_left (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_rotate_right (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (in_len == 0) return (in_len);
...
static u32 rule_op_mangle_delete_first (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (in_len == 0) return (in_len);
...
static u32 rule_op_mangle_delete_last (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (in_len == 0) return (in_len);
...
static u32 rule_op_mangle_delete_at (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_extract (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_omit (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_insert (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 > in_len) return (in_len);
...
static u32 rule_op_mangle_overstrike (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_truncate_at (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_replace (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  #ifdef VECT_SIZE1
  ...
  const uchar8 tmp0 = (uchar8) (p0);
  const uchar8 tmp1 = (uchar8) (p1);

  uchar8 tmp;

  tmp = as_uchar8 (buf0[0]); tmp = select (tmp, tmp1, tmp == tmp0); buf0[0] = as_uint2 (tmp);
  tmp = as_uchar8 (buf0[1]); tmp = select (tmp, tmp1, tmp == tmp0); buf0[1] = as_uint2 (tmp);
  tmp = as_uchar8 (buf0[2]); tmp = select (tmp, tmp1, tmp == tmp0); buf0[2] = as_uint2 (tmp);
  tmp = as_uchar8 (buf0[3]); tmp = select (tmp, tmp1, tmp == tmp0); buf0[3] = as_uint2 (tmp);
  tmp = as_uchar8 (buf1[0]); tmp = select (tmp, tmp1, tmp == tmp0); buf1[0] = as_uint2 (tmp);
  tmp = as_uchar8 (buf1[1]); tmp = select (tmp, tmp1, tmp == tmp0); buf1[1] = as_uint2 (tmp);
  tmp = as_uchar8 (buf1[2]); tmp = select (tmp, tmp1, tmp == tmp0); buf1[2] = as_uint2 (tmp);
  tmp = as_uchar8 (buf1[3]); tmp = select (tmp, tmp1, tmp == tmp0); buf1[3] = as_uint2 (tmp);

  #endif

  #ifdef VECT_SIZE4

  const uchar16 tmp0 = (uchar16) (p0);
  const uchar16 tmp1 = (uchar16) (p1);

  uchar16 tmp;

  tmp = as_uchar16 (buf0[0]); tmp = select (tmp, tmp1, tmp == tmp0); buf0[0] = as_uint4 (tmp);
  tmp = as_uchar16 (buf0[1]); tmp = select (tmp, tmp1, tmp == tmp0); buf0[1] = as_uint4 (tmp);
  tmp = as_uchar16 (buf0[2]); tmp = select (tmp, tmp1, tmp == tmp0); buf0[2] = as_uint4 (tmp);
  tmp = as_uchar16 (buf0[3]); tmp = select (tmp, tmp1, tmp == tmp0); buf0[3] = as_uint4 (tmp);
  tmp = as_uchar16 (buf1[0]); tmp = select (tmp, tmp1, tmp == tmp0); buf1[0] = as_uint4 (tmp);
  tmp = as_uchar16 (buf1[1]); tmp = select (tmp, tmp1, tmp == tmp0); buf1[1] = as_uint4 (tmp);
  tmp = as_uchar16 (buf1[2]); tmp = select (tmp, tmp1, tmp == tmp0); buf1[2] = as_uint4 (tmp);
  tmp = as_uchar16 (buf1[3]); tmp = select (tmp, tmp1, tmp == tmp0); buf1[3] = as_uint4 (tmp);
...
static u32 rule_op_mangle_purgechar (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  // TODO
  return in_len;
}

static u32 rule_op_mangle_togglecase_rec (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  // TODO
  return in_len;
}

static u32 rule_op_mangle_dupechar_first (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if ( in_len       ==  0) return (in_len);
...
static u32 rule_op_mangle_dupechar_last (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if ( in_len       ==  0) return (in_len);
  if ((in_len + p0) >= 32) return (in_len);
...
static u32 rule_op_mangle_dupechar_all (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if ( in_len           ==  0) return (in_len);
  if ((in_len + in_len) >= 32) return (in_len);
...
static u32 rule_op_mangle_switch_first (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_switch_last (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (in_len < 2) return (in_len);
...
static u32 rule_op_mangle_switch_at (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_chr_shiftl (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_chr_shiftr (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_chr_incr (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_chr_decr (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 >= in_len) return (in_len);
...
static u32 rule_op_mangle_replace_np1 (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_replace_nm1 (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
...
static u32 rule_op_mangle_dupeblock_first (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 > in_len) return (in_len);
...
static u32 rule_op_mangle_dupeblock_last (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  if (p0 > in_len) return (in_len);
...
static u32 rule_op_mangle_title (const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  buf0[0] |= (generate_cmask (buf0[0]));
  buf0[1] |= (generate_cmask (buf0[1]));
  buf0[2] |= (generate_cmask (buf0[2]));
  ...
  // The VLIW1 code above freezes VLIW4 and VLIW5 systems
  ...
  for (u32 i = 0; i < in_len; i++)
  {
    ...
    if (i < 3)
    {
      if (tmp0.s0 == ' ') buf0[0].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf0[0].s1 &= tmp1.s1;
    }
    else if (i < 7)
    {
      if (tmp0.s0 == ' ') buf0[1].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf0[1].s1 &= tmp1.s1;
    }
    else if (i < 11)
    {
      if (tmp0.s0 == ' ') buf0[2].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf0[2].s1 &= tmp1.s1;
    }
    else if (i < 15)
    {
      if (tmp0.s0 == ' ') buf0[3].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf0[3].s1 &= tmp1.s1;
    }
    else if (i < 19)
    {
      if (tmp0.s0 == ' ') buf1[0].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf1[0].s1 &= tmp1.s1;
    }
    else if (i < 23)
    {
      if (tmp0.s0 == ' ') buf1[1].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf1[1].s1 &= tmp1.s1;
    }
    else if (i < 27)
    {
      if (tmp0.s0 == ' ') buf1[2].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf1[2].s1 &= tmp1.s1;
    }
    else if (i < 31)
    {
      if (tmp0.s0 == ' ') buf1[3].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf1[3].s1 &= tmp1.s1;
    }
    #endif
    ...
    if (i < 3)
    {
      if (tmp0.s0 == ' ') buf0[0].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf0[0].s1 &= tmp1.s1;
      if (tmp0.s2 == ' ') buf0[0].s2 &= tmp1.s2;
      if (tmp0.s3 == ' ') buf0[0].s3 &= tmp1.s3;
    }
    else if (i < 7)
    {
      if (tmp0.s0 == ' ') buf0[1].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf0[1].s1 &= tmp1.s1;
      if (tmp0.s2 == ' ') buf0[1].s2 &= tmp1.s2;
      if (tmp0.s3 == ' ') buf0[1].s3 &= tmp1.s3;
    }
    else if (i < 11)
    {
      if (tmp0.s0 == ' ') buf0[2].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf0[2].s1 &= tmp1.s1;
      if (tmp0.s2 == ' ') buf0[2].s2 &= tmp1.s2;
      if (tmp0.s3 == ' ') buf0[2].s3 &= tmp1.s3;
    }
    else if (i < 15)
    {
      if (tmp0.s0 == ' ') buf0[3].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf0[3].s1 &= tmp1.s1;
      if (tmp0.s2 == ' ') buf0[3].s2 &= tmp1.s2;
      if (tmp0.s3 == ' ') buf0[3].s3 &= tmp1.s3;
    }
    else if (i < 19)
    {
      if (tmp0.s0 == ' ') buf1[0].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf1[0].s1 &= tmp1.s1;
      if (tmp0.s2 == ' ') buf1[0].s2 &= tmp1.s2;
      if (tmp0.s3 == ' ') buf1[0].s3 &= tmp1.s3;
    }
    else if (i < 23)
    {
      if (tmp0.s0 == ' ') buf1[1].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf1[1].s1 &= tmp1.s1;
      if (tmp0.s2 == ' ') buf1[1].s2 &= tmp1.s2;
      if (tmp0.s3 == ' ') buf1[1].s3 &= tmp1.s3;
    }
    else if (i < 27)
    {
      if (tmp0.s0 == ' ') buf1[2].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf1[2].s1 &= tmp1.s1;
      if (tmp0.s2 == ' ') buf1[2].s2 &= tmp1.s2;
      if (tmp0.s3 == ' ') buf1[2].s3 &= tmp1.s3;
    }
    else if (i < 31)
    {
      if (tmp0.s0 == ' ') buf1[3].s0 &= tmp1.s0;
      if (tmp0.s1 == ' ') buf1[3].s1 &= tmp1.s1;
      if (tmp0.s2 == ' ') buf1[3].s2 &= tmp1.s2;
      if (tmp0.s3 == ' ') buf1[3].s3 &= tmp1.s3;
    }
    #endif
  }
...
u32 apply_rule (const u32 name, const u32 p0, const u32 p1, u32x buf0[4], u32x buf1[4], const u32 in_len)
{
  u32 out_len = in_len;
...
u32 apply_rules (__global u32 *cmds, u32x buf0[4], u32x buf1[4], const u32 len)
{
  u32 out_len = len;
