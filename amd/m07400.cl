...
static void sha256_transform_no14 (const u32x w[16], u32x digest[8])
{
  u32x w_t[16];
...
static void init_ctx (u32x digest[8])
{
  digest[0] = SHA256M_A;
  digest[1] = SHA256M_B;
  digest[2] = SHA256M_C;
...
static void bzero16 (u32x block[16])
{
  block[ 0] = 0;
  block[ 1] = 0;
  block[ 2] = 0;
...
static void bswap8 (u32x block[16])
{
...
static u32 memcat16 (u32x block[16], const u32 block_len, const u32x append[4], const u32 append_len)
{
...
static u32 memcat16c (u32x block[16], const u32 block_len, const u32x append[4], const u32 append_len, u32x digest[8])
{
  const u32 mod = block_len & 3;
  const u32 div = block_len / 4;
...
static u32 memcat20 (u32x block[20], const u32 block_len, const u32x append[4], const u32 append_len)
{
  const u32 mod = block_len & 3;
  const u32 div = block_len / 4;
...
static u32 memcat20_x80 (u32x block[20], const u32 block_len, const u32x append[4], const u32 append_len)
{
  const u32 mod = block_len & 3;
  const u32 div = block_len / 4;
