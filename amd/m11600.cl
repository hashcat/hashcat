...
static u32 memcat8c (u32x block[16], const u32 block_len, const u32x append[2], const u32 append_len, u32x digest[8])
{
...
static u32 memcat32c (u32x block[16], const u32 block_len, const u32x append[8], const u32 append_len, u32x digest[8])
{
  const u32 mod = block_len & 3;
  const u32 div = block_len / 4;
