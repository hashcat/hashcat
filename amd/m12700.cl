...
__kernel void __attribute__((reqd_work_group_size (64, 1, 1))) m12700_init (__global pw_t *pws, __global gpu_rule_t *rules_buf, __global comb_t *combs_buf, __global bf_t *bfs_buf, __global mywallet_tmp_t *tmps, __global void *hooks, __global u32 *bitmaps_buf_s1_a, __global u32 *bitmaps_buf_s1_b, __global u32 *bitmaps_buf_s1_c, __global u32 *bitmaps_buf_s1_d, __global u32 *bitmaps_buf_s2_a, __global u32 *bitmaps_buf_s2_b, __global u32 *bitmaps_buf_s2_c, __global u32 *bitmaps_buf_s2_d, __global plain_t *plains_buf, __global digest_t *digests_buf, __global u32 *hashes_shown, __global salt_t *salt_bufs, __global void *esalt_bufs, __global u32 *d_return_buf, __global u32 *d_scryptV_buf, const u32 bitmap_mask, const u32 bitmap_shift1, const u32 bitmap_shift2, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u32 rules_cnt, const u32 digests_cnt, const u32 digests_offset, const u32 combs_mode, const u32 gid_max)
{
...

  {
    ...
    hmac_sha1_run (w0, w1, w2, w3, ipad, opad, dgst1);

    tmps[gid].dgst1[0] = dgst1[0];
    tmps[gid].dgst1[1] = dgst1[1];
    tmps[gid].dgst1[2] = dgst1[2];
    tmps[gid].dgst1[3] = dgst1[3];
    tmps[gid].dgst1[4] = dgst1[4];

    tmps[gid].out1[0] = dgst1[0];
    tmps[gid].out1[1] = dgst1[1];
    tmps[gid].out1[2] = dgst1[2];
    tmps[gid].out1[3] = dgst1[3];
    tmps[gid].out1[4] = dgst1[4];
  }
...

  {
    ...
    hmac_sha1_run (w0, w1, w2, w3, ipad, opad, dgst2);

    tmps[gid].dgst2[0] = dgst2[0];
    tmps[gid].dgst2[1] = dgst2[1];
    tmps[gid].dgst2[2] = dgst2[2];
    tmps[gid].dgst2[3] = dgst2[3];
    tmps[gid].dgst2[4] = dgst2[4];

    tmps[gid].out2[0] = dgst2[0];
    tmps[gid].out2[1] = dgst2[1];
    tmps[gid].out2[2] = dgst2[2];
    tmps[gid].out2[3] = dgst2[3];
    tmps[gid].out2[4] = dgst2[4];
  }
}
...
__kernel void __attribute__((reqd_work_group_size (64, 1, 1))) m12700_loop (__global pw_t *pws, __global gpu_rule_t *rules_buf, __global comb_t *combs_buf, __global bf_t *bfs_buf, __global mywallet_tmp_t *tmps, __global void *hooks, __global u32 *bitmaps_buf_s1_a, __global u32 *bitmaps_buf_s1_b, __global u32 *bitmaps_buf_s1_c, __global u32 *bitmaps_buf_s1_d, __global u32 *bitmaps_buf_s2_a, __global u32 *bitmaps_buf_s2_b, __global u32 *bitmaps_buf_s2_c, __global u32 *bitmaps_buf_s2_d, __global plain_t *plains_buf, __global digest_t *digests_buf, __global u32 *hashes_shown, __global salt_t *salt_bufs, __global void *esalt_bufs, __global u32 *d_return_buf, __global u32 *d_scryptV_buf, const u32 bitmap_mask, const u32 bitmap_shift1, const u32 bitmap_shift2, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u32 rules_cnt, const u32 digests_cnt, const u32 digests_offset, const u32 combs_mode, const u32 gid_max)
{
...

  {
    ...
    dgst1[0] = tmps[gid].dgst1[0];
    dgst1[1] = tmps[gid].dgst1[1];
    dgst1[2] = tmps[gid].dgst1[2];
    dgst1[3] = tmps[gid].dgst1[3];
    dgst1[4] = tmps[gid].dgst1[4];

    out1[0] = tmps[gid].out1[0];
    out1[1] = tmps[gid].out1[1];
    out1[2] = tmps[gid].out1[2];
    out1[3] = tmps[gid].out1[3];
    out1[4] = tmps[gid].out1[4];
    ...
    tmps[gid].out1[0] = out1[0];
    tmps[gid].out1[1] = out1[1];
    tmps[gid].out1[2] = out1[2];
    tmps[gid].out1[3] = out1[3];
    tmps[gid].out1[4] = out1[4];
  }
...

  {
    ...
    dgst2[0] = tmps[gid].dgst2[0];
    dgst2[1] = tmps[gid].dgst2[1];
    dgst2[2] = tmps[gid].dgst2[2];
    dgst2[3] = tmps[gid].dgst2[3];
    dgst2[4] = tmps[gid].dgst2[4];

    out2[0] = tmps[gid].out2[0];
    out2[1] = tmps[gid].out2[1];
    out2[2] = tmps[gid].out2[2];
    out2[3] = tmps[gid].out2[3];
    out2[4] = tmps[gid].out2[4];
    ...
    tmps[gid].out2[0] = out2[0];
    tmps[gid].out2[1] = out2[1];
    tmps[gid].out2[2] = out2[2];
    tmps[gid].out2[3] = out2[3];
    tmps[gid].out2[4] = out2[4];
  }
}

__kernel void __attribute__((reqd_work_group_size (64, 1, 1))) m12700_comp (__global pw_t *pws, __global gpu_rule_t *rules_buf, __global comb_t *combs_buf, __global bf_t *bfs_buf, __global mywallet_tmp_t *tmps, __global void *hooks, __global u32 *bitmaps_buf_s1_a, __global u32 *bitmaps_buf_s1_b, __global u32 *bitmaps_buf_s1_c, __global u32 *bitmaps_buf_s1_d, __global u32 *bitmaps_buf_s2_a, __global u32 *bitmaps_buf_s2_b, __global u32 *bitmaps_buf_s2_c, __global u32 *bitmaps_buf_s2_d, __global plain_t *plains_buf, __global digest_t *digests_buf, __global u32 *hashes_shown, __global salt_t *salt_bufs, __global void *esalt_bufs, __global u32 *d_return_buf, __global u32 *d_scryptV_buf, const u32 bitmap_mask, const u32 bitmap_shift1, const u32 bitmap_shift2, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u32 rules_cnt, const u32 digests_cnt, const u32 digests_offset, const u32 combs_mode, const u32 gid_max)
{
  /**
   * base
   */
  ...
  ukey[0] = tmps[gid].out1[0];
  ukey[1] = tmps[gid].out1[1];
  ukey[2] = tmps[gid].out1[2];
  ukey[3] = tmps[gid].out1[3];
  ukey[4] = tmps[gid].out1[4];
  ukey[5] = tmps[gid].out2[0];
  ukey[6] = tmps[gid].out2[1];
  ukey[7] = tmps[gid].out2[2];

  #define KEYLEN 60

  u32 rk[KEYLEN];

  AES256_ExpandKey (ukey, rk, s_te0, s_te1, s_te2, s_te3, s_te4);
  ...
  for (int i = 1; i < 16 - 6; i++)
  {
    ...
    const u32x r0 = data[0];
    const u32x r1 = data[1];
    const u32x r2 = data[2];
    const u32x r3 = data[3];
